...
public class UploadImageResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "url", "media", "reason", "code"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UploadImageResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UploadImageResponse is not found in the empty JSON string", UploadImageResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UploadImageResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UploadImageResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
