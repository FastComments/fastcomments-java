...
public class DeleteQuestionResultResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteQuestionResultResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteQuestionResultResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteQuestionResultResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteQuestionResultResponse>() {
                @Override
                public void write(JsonWriter out, DeleteQuestionResultResponse value) throws IOException {
                ...
                @Override
                public DeleteQuestionResultResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteQuestionResultResponse ret = new DeleteQuestionResultResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteQuestionResultResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteQuestionResultResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public DeleteQuestionResultResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteQuestionResultResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteQuestionResultResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteQuestionResultResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteQuestionResultResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteQuestionResultResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteQuestionResultResponse
     */
    public static DeleteQuestionResultResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteQuestionResultResponse.class);
    }

    /**
     * Convert an instance of DeleteQuestionResultResponse to an JSON string
     *
     * @return JSON string
     */
