...
public class GetCommentText200Response extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetCommentText200Response>() {
                ...
                public void write(JsonWriter out, GetCommentText200Response value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, PublicAPIGetCommentTextResponse");
                }
     ...
     * PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, PublicAPIGetCommentTextResponse
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, PublicAPIGetCommentTextResponse");
    }
     ...
     * PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, PublicAPIGetCommentTextResponse
     *
     * @return The actual instance (PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, PublicAPIGetCommentTextResponse)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for GetCommentText200Response with anyOf schemas: PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, PublicAPIGetCommentTextResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
