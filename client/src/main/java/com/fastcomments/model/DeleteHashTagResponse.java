...
public class DeleteHashTagResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteHashTagResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteHashTagResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteHashTagResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteHashTagResponse>() {
                @Override
                public void write(JsonWriter out, DeleteHashTagResponse value) throws IOException {
                ...
                @Override
                public DeleteHashTagResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteHashTagResponse ret = new DeleteHashTagResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteHashTagResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteHashTagResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public DeleteHashTagResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteHashTagResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteHashTagResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteHashTagResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteHashTagResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteHashTagResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteHashTagResponse
     */
    public static DeleteHashTagResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteHashTagResponse.class);
    }

    /**
     * Convert an instance of DeleteHashTagResponse to an JSON string
     *
     * @return JSON string
     */
