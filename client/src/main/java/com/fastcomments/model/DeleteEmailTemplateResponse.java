...
public class DeleteEmailTemplateResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteEmailTemplateResponse.class.getName());
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteEmailTemplateResponse>() {
                ...
                public DeleteEmailTemplateResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteEmailTemplateResponse ret = new DeleteEmailTemplateResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteEmailTemplateResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteEmailTemplateResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteEmailTemplateResponse.schemas;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteEmailTemplateResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
