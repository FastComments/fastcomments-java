...
public class DeletePendingWebhookEventResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeletePendingWebhookEventResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeletePendingWebhookEventResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeletePendingWebhookEventResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeletePendingWebhookEventResponse>() {
                @Override
                public void write(JsonWriter out, DeletePendingWebhookEventResponse value) throws IOException {
                ...
                @Override
                public DeletePendingWebhookEventResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeletePendingWebhookEventResponse ret = new DeletePendingWebhookEventResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for APIEmptyResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeletePendingWebhookEventResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeletePendingWebhookEventResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public DeletePendingWebhookEventResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeletePendingWebhookEventResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeletePendingWebhookEventResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeletePendingWebhookEventResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeletePendingWebhookEventResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeletePendingWebhookEventResponse
     * @throws IOException if the JSON string is invalid with respect to DeletePendingWebhookEventResponse
     */
    public static DeletePendingWebhookEventResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeletePendingWebhookEventResponse.class);
    }

    /**
     * Convert an instance of DeletePendingWebhookEventResponse to an JSON string
     *
     * @return JSON string
     */
