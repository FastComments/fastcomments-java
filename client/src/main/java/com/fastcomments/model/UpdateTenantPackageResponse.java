...
public class UpdateTenantPackageResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateTenantPackageResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateTenantPackageResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateTenantPackageResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateTenantPackageResponse>() {
                @Override
                public void write(JsonWriter out, UpdateTenantPackageResponse value) throws IOException {
                ...
                @Override
                public UpdateTenantPackageResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateTenantPackageResponse ret = new UpdateTenantPackageResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateTenantPackageResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateTenantPackageResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateTenantPackageResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateTenantPackageResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateTenantPackageResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateTenantPackageResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateTenantPackageResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateTenantPackageResponse
     */
    public static UpdateTenantPackageResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateTenantPackageResponse.class);
    }

    /**
     * Convert an instance of UpdateTenantPackageResponse to an JSON string
     *
     * @return JSON string
     */
