...
public class SendLoginLinkResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SendLoginLinkResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SendLoginLinkResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SendLoginLinkResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SendLoginLinkResponse>() {
                @Override
                public void write(JsonWriter out, SendLoginLinkResponse value) throws IOException {
                ...
                @Override
                public SendLoginLinkResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        SendLoginLinkResponse ret = new SendLoginLinkResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for SendLoginLinkResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SendLoginLinkResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public SendLoginLinkResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return SendLoginLinkResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to SendLoginLinkResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for SendLoginLinkResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of SendLoginLinkResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SendLoginLinkResponse
     * @throws IOException if the JSON string is invalid with respect to SendLoginLinkResponse
     */
    public static SendLoginLinkResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SendLoginLinkResponse.class);
    }

    /**
     * Convert an instance of SendLoginLinkResponse to an JSON string
     *
     * @return JSON string
     */
