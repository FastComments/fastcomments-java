...
public class UpdateQuestionResultResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateQuestionResultResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateQuestionResultResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateQuestionResultResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateQuestionResultResponse>() {
                @Override
                public void write(JsonWriter out, UpdateQuestionResultResponse value) throws IOException {
                ...
                @Override
                public UpdateQuestionResultResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateQuestionResultResponse ret = new UpdateQuestionResultResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateQuestionResultResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateQuestionResultResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateQuestionResultResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateQuestionResultResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateQuestionResultResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateQuestionResultResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateQuestionResultResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateQuestionResultResponse
     */
    public static UpdateQuestionResultResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateQuestionResultResponse.class);
    }

    /**
     * Convert an instance of UpdateQuestionResultResponse to an JSON string
     *
     * @return JSON string
     */
