...
public class CreateCommentPublicResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateCommentPublicResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCommentPublicResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCommentPublicResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCommentPublicResponse>() {
                @Override
                public void write(JsonWriter out, CreateCommentPublicResponse value) throws IOException {
                ...
                @Override
                public CreateCommentPublicResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CreateCommentPublicResponse ret = new CreateCommentPublicResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for SaveCommentsResponseWithPresence failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateCommentPublicResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateCommentPublicResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CreateCommentPublicResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreateCommentPublicResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CreateCommentPublicResponse with anyOf schemas: APIError, SaveCommentsResponseWithPresence. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CreateCommentPublicResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CreateCommentPublicResponse
     * @throws IOException if the JSON string is invalid with respect to CreateCommentPublicResponse
     */
    public static CreateCommentPublicResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CreateCommentPublicResponse.class);
    }

    /**
     * Convert an instance of CreateCommentPublicResponse to an JSON string
     *
     * @return JSON string
     */
