...
public class CheckedCommentsForBlockedResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CheckedCommentsForBlockedResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CheckedCommentsForBlockedResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CheckedCommentsForBlockedResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CheckedCommentsForBlockedResponse>() {
                @Override
                public void write(JsonWriter out, CheckedCommentsForBlockedResponse value) throws IOException {
                ...
                @Override
                public CheckedCommentsForBlockedResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CheckedCommentsForBlockedResponse ret = new CheckedCommentsForBlockedResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CheckedCommentsForBlockedResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CheckedCommentsForBlockedResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CheckedCommentsForBlockedResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CheckedCommentsForBlockedResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CheckedCommentsForBlockedResponse with anyOf schemas: APIError, CheckBlockedCommentsResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CheckedCommentsForBlockedResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CheckedCommentsForBlockedResponse
     * @throws IOException if the JSON string is invalid with respect to CheckedCommentsForBlockedResponse
     */
    public static CheckedCommentsForBlockedResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CheckedCommentsForBlockedResponse.class);
    }

    /**
     * Convert an instance of CheckedCommentsForBlockedResponse to an JSON string
     *
     * @return JSON string
     */
