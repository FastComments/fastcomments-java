...
public class GetComment200Response extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetComment200Response>() {
                ...
                public void write(JsonWriter out, GetComment200Response value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: APIGetCommentResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode");
                }
     ...
     * APIGetCommentResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be APIGetCommentResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode");
    }
     ...
     * APIGetCommentResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode
     *
     * @return The actual instance (APIGetCommentResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for GetComment200Response with anyOf schemas: APIGetCommentResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
