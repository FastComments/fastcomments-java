...
public class UpdateQuestionConfigResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateQuestionConfigResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateQuestionConfigResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateQuestionConfigResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateQuestionConfigResponse>() {
                @Override
                public void write(JsonWriter out, UpdateQuestionConfigResponse value) throws IOException {
                ...
                @Override
                public UpdateQuestionConfigResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateQuestionConfigResponse ret = new UpdateQuestionConfigResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateQuestionConfigResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateQuestionConfigResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateQuestionConfigResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateQuestionConfigResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateQuestionConfigResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateQuestionConfigResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateQuestionConfigResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateQuestionConfigResponse
     */
    public static UpdateQuestionConfigResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateQuestionConfigResponse.class);
    }

    /**
     * Convert an instance of UpdateQuestionConfigResponse to an JSON string
     *
     * @return JSON string
     */
