...
public class PutReopenThreadResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PutReopenThreadResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PutReopenThreadResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PutReopenThreadResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PutReopenThreadResponse>() {
                @Override
                public void write(JsonWriter out, PutReopenThreadResponse value) throws IOException {
                ...
                @Override
                public PutReopenThreadResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PutReopenThreadResponse ret = new PutReopenThreadResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PutReopenThreadResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PutReopenThreadResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public PutReopenThreadResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PutReopenThreadResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PutReopenThreadResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PutReopenThreadResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PutReopenThreadResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PutReopenThreadResponse
     * @throws IOException if the JSON string is invalid with respect to PutReopenThreadResponse
     */
    public static PutReopenThreadResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PutReopenThreadResponse.class);
    }

    /**
     * Convert an instance of PutReopenThreadResponse to an JSON string
     *
     * @return JSON string
     */
