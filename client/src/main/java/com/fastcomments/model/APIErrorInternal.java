...
public class APIErrorInternal {
  ...
  public APIErrorInternal() {
  }

  public APIErrorInternal statusCode(@javax.annotation.Nullable Double statusCode) {
  ...
  public APIErrorInternal status(@javax.annotation.Nonnull ImportedAPIStatusFAILED status) {
    this.status = status;
    return this;
  }
  ...
  public APIErrorInternal reason(@javax.annotation.Nonnull String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public APIErrorInternal code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public APIErrorInternal secondaryCode(@javax.annotation.Nullable String secondaryCode) {
  ...
  public APIErrorInternal bannedUntil(@javax.annotation.Nullable Double bannedUntil) {
  ...
  public APIErrorInternal maxCharacterLength(@javax.annotation.Nullable Double maxCharacterLength) {
  ...
  public APIErrorInternal translatedError(@javax.annotation.Nullable String translatedError) {
  ...
  public APIErrorInternal customConfig(@javax.annotation.Nullable CustomConfigParameters customConfig) {
  ...
  public boolean equals(Object o) {
    ...
    APIErrorInternal apIErrorInternal = (APIErrorInternal) o;
    return Objects.equals(this.statusCode, apIErrorInternal.statusCode) &&
        Objects.equals(this.status, apIErrorInternal.status) &&
        Objects.equals(this.reason, apIErrorInternal.reason) &&
        Objects.equals(this.code, apIErrorInternal.code) &&
        Objects.equals(this.secondaryCode, apIErrorInternal.secondaryCode) &&
        Objects.equals(this.bannedUntil, apIErrorInternal.bannedUntil) &&
        Objects.equals(this.maxCharacterLength, apIErrorInternal.maxCharacterLength) &&
        Objects.equals(this.translatedError, apIErrorInternal.translatedError) &&
        Objects.equals(this.customConfig, apIErrorInternal.customConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIErrorInternal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to APIErrorInternal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIErrorInternal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APIErrorInternal is not found in the empty JSON string", APIErrorInternal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APIErrorInternal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `APIErrorInternal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : APIErrorInternal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIErrorInternal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIErrorInternal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIErrorInternal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIErrorInternal.class));

       return (TypeAdapter<T>) new TypeAdapter<APIErrorInternal>() {
           @Override
           public void write(JsonWriter out, APIErrorInternal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APIErrorInternal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APIErrorInternal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APIErrorInternal
   * @throws IOException if the JSON string is invalid with respect to APIErrorInternal
   */
  public static APIErrorInternal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIErrorInternal.class);
  }

  /**
   * Convert an instance of APIErrorInternal to an JSON string
   *
   * @return JSON string
   */
