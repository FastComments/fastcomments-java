...
public class GetFeedPostsPublic200Response extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetFeedPostsPublic200Response.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFeedPostsPublic200Response.class.isAssignableFrom(type.getRawType())) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetFeedPostsPublic200Response>() {
                @Override
                public void write(JsonWriter out, GetFeedPostsPublic200Response value) throws IOException {
                ...
                @Override
                public GetFeedPostsPublic200Response read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetFeedPostsPublic200Response: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetFeedPostsPublic200Response(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetFeedPostsPublic200Response.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetFeedPostsPublic200Response
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for GetFeedPostsPublic200Response with anyOf schemas: APIError, PublicFeedPostsResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GetFeedPostsPublic200Response given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetFeedPostsPublic200Response
     * @throws IOException if the JSON string is invalid with respect to GetFeedPostsPublic200Response
     */
    public static GetFeedPostsPublic200Response fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetFeedPostsPublic200Response.class);
    }

    /**
     * Convert an instance of GetFeedPostsPublic200Response to an JSON string
     *
     * @return JSON string
     */
