...
public class LiveEventExtraInfo {
   ...
   * @return the LiveEventExtraInfo instance itself
   */
  public LiveEventExtraInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commentPositions, liveEventExtraInfo.commentPositions)&&
        Objects.equals(this.additionalProperties, liveEventExtraInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commentPositions, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("commentPositions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LiveEventExtraInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LiveEventExtraInfo is not found in the empty JSON string", LiveEventExtraInfo.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LiveEventExtraInfo>() {
           ...
           public LiveEventExtraInfo read(JsonReader in) throws IOException {
             ...
             LiveEventExtraInfo instance = thisAdapter.fromJsonTree(jsonObj);
