...
public class BulkAggregateQuestionResultsRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("aggregations"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("aggregations"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BulkAggregateQuestionResultsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BulkAggregateQuestionResultsRequest is not found in the empty JSON string", BulkAggregateQuestionResultsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BulkAggregateQuestionResultsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BulkAggregateQuestionResultsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
