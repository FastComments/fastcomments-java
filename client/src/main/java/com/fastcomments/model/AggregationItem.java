...
public class AggregationItem {
   ...
   * @return the AggregationItem instance itself
   */
  public AggregationItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groups, aggregationItem.groups)&&
        Objects.equals(this.additionalProperties, aggregationItem.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregationItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AggregationItem is not found in the empty JSON string", AggregationItem.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AggregationItem>() {
           ...
           public AggregationItem read(JsonReader in) throws IOException {
             ...
             AggregationItem instance = thisAdapter.fromJsonTree(jsonObj);
