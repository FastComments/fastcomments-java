...
public class VoteCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(VoteCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!VoteCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'VoteCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<VoteCommentResponse>() {
                @Override
                public void write(JsonWriter out, VoteCommentResponse value) throws IOException {
                ...
                @Override
                public VoteCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        VoteCommentResponse ret = new VoteCommentResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for VoteResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for VoteCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public VoteCommentResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public VoteCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return VoteCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to VoteCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for VoteCommentResponse with anyOf schemas: APIError, VoteResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of VoteCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of VoteCommentResponse
     * @throws IOException if the JSON string is invalid with respect to VoteCommentResponse
     */
    public static VoteCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, VoteCommentResponse.class);
    }

    /**
     * Convert an instance of VoteCommentResponse to an JSON string
     *
     * @return JSON string
     */
