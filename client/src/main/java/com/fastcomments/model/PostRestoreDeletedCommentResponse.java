...
public class PostRestoreDeletedCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PostRestoreDeletedCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostRestoreDeletedCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostRestoreDeletedCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PostRestoreDeletedCommentResponse>() {
                @Override
                public void write(JsonWriter out, PostRestoreDeletedCommentResponse value) throws IOException {
                ...
                @Override
                public PostRestoreDeletedCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PostRestoreDeletedCommentResponse ret = new PostRestoreDeletedCommentResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PostRestoreDeletedCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PostRestoreDeletedCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PostRestoreDeletedCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostRestoreDeletedCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PostRestoreDeletedCommentResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PostRestoreDeletedCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostRestoreDeletedCommentResponse
     * @throws IOException if the JSON string is invalid with respect to PostRestoreDeletedCommentResponse
     */
    public static PostRestoreDeletedCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostRestoreDeletedCommentResponse.class);
    }

    /**
     * Convert an instance of PostRestoreDeletedCommentResponse to an JSON string
     *
     * @return JSON string
     */
