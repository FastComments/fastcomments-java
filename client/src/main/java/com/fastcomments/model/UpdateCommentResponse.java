...
public class UpdateCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateCommentResponse.class.getName());
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateCommentResponse>() {
                ...
                public UpdateCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateCommentResponse ret = new UpdateCommentResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateCommentResponse.schemas;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateCommentResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
