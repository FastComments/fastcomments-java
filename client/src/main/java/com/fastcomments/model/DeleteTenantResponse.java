...
public class DeleteTenantResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteTenantResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteTenantResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteTenantResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteTenantResponse>() {
                @Override
                public void write(JsonWriter out, DeleteTenantResponse value) throws IOException {
                ...
                @Override
                public DeleteTenantResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteTenantResponse ret = new DeleteTenantResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteTenantResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteTenantResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteTenantResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteTenantResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteTenantResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteTenantResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteTenantResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteTenantResponse
     */
    public static DeleteTenantResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteTenantResponse.class);
    }

    /**
     * Convert an instance of DeleteTenantResponse to an JSON string
     *
     * @return JSON string
     */
