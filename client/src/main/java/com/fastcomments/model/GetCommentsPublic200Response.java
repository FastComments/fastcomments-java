...
public class GetCommentsPublic200Response extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetCommentsPublic200Response>() {
                ...
                public GetCommentsPublic200Response read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for GetCommentsResponseWithPresencePublicComment failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetCommentsPublic200Response: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for GetCommentsPublic200Response with anyOf schemas: APIError, GetCommentsResponseWithPresencePublicComment. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
