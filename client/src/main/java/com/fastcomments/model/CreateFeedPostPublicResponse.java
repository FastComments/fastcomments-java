...
public class CreateFeedPostPublicResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateFeedPostPublicResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateFeedPostPublicResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateFeedPostPublicResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateFeedPostPublicResponse>() {
                @Override
                public void write(JsonWriter out, CreateFeedPostPublicResponse value) throws IOException {
                ...
                @Override
                public CreateFeedPostPublicResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CreateFeedPostPublicResponse ret = new CreateFeedPostPublicResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CreateFeedPostResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateFeedPostPublicResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateFeedPostPublicResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public CreateFeedPostPublicResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CreateFeedPostPublicResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreateFeedPostPublicResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CreateFeedPostPublicResponse with anyOf schemas: APIError, CreateFeedPostResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CreateFeedPostPublicResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CreateFeedPostPublicResponse
     * @throws IOException if the JSON string is invalid with respect to CreateFeedPostPublicResponse
     */
    public static CreateFeedPostPublicResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CreateFeedPostPublicResponse.class);
    }

    /**
     * Convert an instance of CreateFeedPostPublicResponse to an JSON string
     *
     * @return JSON string
     */
