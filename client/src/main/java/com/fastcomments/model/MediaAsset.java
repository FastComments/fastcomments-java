...
public class MediaAsset {
  ...
  public MediaAsset src(@javax.annotation.Nonnull String src) {
    this.src = src;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.w, mediaAsset.w) &&
        Objects.equals(this.h, mediaAsset.h) &&
        Objects.equals(this.src, mediaAsset.src);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MediaAsset
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MediaAsset.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MediaAsset' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MediaAsset> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MediaAsset.class));

       return (TypeAdapter<T>) new TypeAdapter<MediaAsset>() {
           @Override
           public void write(JsonWriter out, MediaAsset value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MediaAsset read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MediaAsset given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MediaAsset
   * @throws IOException if the JSON string is invalid with respect to MediaAsset
   */
  public static MediaAsset fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MediaAsset.class);
  }

  /**
   * Convert an instance of MediaAsset to an JSON string
   *
   * @return JSON string
   */
