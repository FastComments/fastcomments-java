...
public class PublicFeedPostsResponse {
   ...
   * @return the PublicFeedPostsResponse instance itself
   */
  public PublicFeedPostsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, publicFeedPostsResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, publicFeedPostsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, feedPosts, user, urlIdWS, userIdWS, tenantIdWS, myReacts, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "feedPosts", "user", "urlIdWS", "userIdWS", "tenantIdWS", "myReacts"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublicFeedPostsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PublicFeedPostsResponse is not found in the empty JSON string", PublicFeedPostsResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PublicFeedPostsResponse>() {
           ...
           public PublicFeedPostsResponse read(JsonReader in) throws IOException {
             ...
             PublicFeedPostsResponse instance = thisAdapter.fromJsonTree(jsonObj);
