...
public class PickFCommentPublicCommentFieldsKeys {
  ...
  public PickFCommentPublicCommentFieldsKeys viewCount(@javax.annotation.Nullable Long viewCount) {
   ...
   * @return the PickFCommentPublicCommentFieldsKeys instance itself
   */
  public PickFCommentPublicCommentFieldsKeys putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, pickFCommentPublicCommentFieldsKeys.date) &&
        ...
        Objects.equals(this.additionalProperties, pickFCommentPublicCommentFieldsKeys.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, id, userId, anonUserId, commenterName, commenterLink, commentHTML, parentId, votes, votesUp, votesDown, verified, avatarSrc, isSpam, hasImages, isDeleted, isDeletedUser, isByAdmin, isByModerator, isPinned, isLocked, rating, displayLabel, badges, feedbackIds, viewCount, requiresVerification, editKey, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PickFCommentPublicCommentFieldsKeys>() {
           ...
           public PickFCommentPublicCommentFieldsKeys read(JsonReader in) throws IOException {
             ...
             PickFCommentPublicCommentFieldsKeys instance = thisAdapter.fromJsonTree(jsonObj);
