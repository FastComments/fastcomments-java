...
public class PickTenantAuditLogTenantAuditLogKeys {
   ...
   * @return the PickTenantAuditLogTenantAuditLogKeys instance itself
   */
  public PickTenantAuditLogTenantAuditLogKeys putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, pickTenantAuditLogTenantAuditLogKeys.id) &&
        ...
        Objects.equals(this.additionalProperties, pickTenantAuditLogTenantAuditLogKeys.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, url, userId, username, resourceName, crudType, from, ip, when, description, serverStartDate, objectDetails, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PickTenantAuditLogTenantAuditLogKeys>() {
           ...
           public PickTenantAuditLogTenantAuditLogKeys read(JsonReader in) throws IOException {
             ...
             PickTenantAuditLogTenantAuditLogKeys instance = thisAdapter.fromJsonTree(jsonObj);
