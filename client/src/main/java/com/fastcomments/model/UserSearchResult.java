...
public class UserSearchResult {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "displayName", "avatarSrc", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserSearchResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserSearchResult is not found in the empty JSON string", UserSearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserSearchResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
