...
public class UnBlockCommentPublicResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UnBlockCommentPublicResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UnBlockCommentPublicResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UnBlockCommentPublicResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UnBlockCommentPublicResponse>() {
                @Override
                public void write(JsonWriter out, UnBlockCommentPublicResponse value) throws IOException {
                ...
                @Override
                public UnBlockCommentPublicResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UnBlockCommentPublicResponse ret = new UnBlockCommentPublicResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UnBlockCommentPublicResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UnBlockCommentPublicResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UnBlockCommentPublicResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UnBlockCommentPublicResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UnBlockCommentPublicResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UnBlockCommentPublicResponse with anyOf schemas: APIError, UnblockSuccess. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UnBlockCommentPublicResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UnBlockCommentPublicResponse
     * @throws IOException if the JSON string is invalid with respect to UnBlockCommentPublicResponse
     */
    public static UnBlockCommentPublicResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UnBlockCommentPublicResponse.class);
    }

    /**
     * Convert an instance of UnBlockCommentPublicResponse to an JSON string
     *
     * @return JSON string
     */
