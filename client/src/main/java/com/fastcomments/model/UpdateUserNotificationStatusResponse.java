...
public class UpdateUserNotificationStatusResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateUserNotificationStatusResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateUserNotificationStatusResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateUserNotificationStatusResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateUserNotificationStatusResponse>() {
                @Override
                public void write(JsonWriter out, UpdateUserNotificationStatusResponse value) throws IOException {
                ...
                @Override
                public UpdateUserNotificationStatusResponse read(JsonReader in) throws IOException {
    ...
    public UpdateUserNotificationStatusResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UpdateUserNotificationStatusResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateUserNotificationStatusResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateUserNotificationStatusResponse
     */
    ...
    /**
     * Create an instance of UpdateUserNotificationStatusResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateUserNotificationStatusResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateUserNotificationStatusResponse
     */
    public static UpdateUserNotificationStatusResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateUserNotificationStatusResponse.class);
    }

    /**
     * Convert an instance of UpdateUserNotificationStatusResponse to an JSON string
     *
     * @return JSON string
     */
