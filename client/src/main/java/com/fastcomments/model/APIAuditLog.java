...
public class APIAuditLog {
  ...
  public APIAuditLog id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public APIAuditLog userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public APIAuditLog username(@javax.annotation.Nullable String username) {
  ...
  public APIAuditLog resourceName(@javax.annotation.Nonnull String resourceName) {
  ...
  public APIAuditLog crudType(@javax.annotation.Nonnull CrudTypeEnum crudType) {
  ...
  public APIAuditLog from(@javax.annotation.Nullable FromEnum from) {
    this.from = from;
    return this;
  }
  ...
  public APIAuditLog url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public APIAuditLog ip(@javax.annotation.Nullable String ip) {
    this.ip = ip;
    return this;
  }
  ...
  public APIAuditLog when(@javax.annotation.Nullable OffsetDateTime when) {
    this.when = when;
    return this;
  }
  ...
  public APIAuditLog description(@javax.annotation.Nullable String description) {
  ...
  public APIAuditLog serverStartDate(@javax.annotation.Nullable OffsetDateTime serverStartDate) {
  ...
  public APIAuditLog objectDetails(@javax.annotation.Nullable Map<String, Object> objectDetails) {
    this.objectDetails = objectDetails;
    return this;
  }

  public APIAuditLog putObjectDetailsItem(String key, Object objectDetailsItem) {
  ...
  public boolean equals(Object o) {
    ...
    APIAuditLog apIAuditLog = (APIAuditLog) o;
    return Objects.equals(this.id, apIAuditLog.id) &&
        Objects.equals(this.userId, apIAuditLog.userId) &&
        Objects.equals(this.username, apIAuditLog.username) &&
        Objects.equals(this.resourceName, apIAuditLog.resourceName) &&
        Objects.equals(this.crudType, apIAuditLog.crudType) &&
        Objects.equals(this.from, apIAuditLog.from) &&
        Objects.equals(this.url, apIAuditLog.url) &&
        Objects.equals(this.ip, apIAuditLog.ip) &&
        Objects.equals(this.when, apIAuditLog.when) &&
        Objects.equals(this.description, apIAuditLog.description) &&
        Objects.equals(this.serverStartDate, apIAuditLog.serverStartDate) &&
        Objects.equals(this.objectDetails, apIAuditLog.objectDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, userId, username, resourceName, crudType, from, url, ip, when, description, serverStartDate, objectDetails);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class APIAuditLog {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "userId", "username", "resourceName", "crudType", "from", "url", "ip", "when", "description", "serverStartDate", "objectDetails"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_id", "resourceName", "crudType"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to APIAuditLog
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIAuditLog.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in APIAuditLog is not found in the empty JSON string", APIAuditLog.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APIAuditLog.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `APIAuditLog` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : APIAuditLog.openapiRequiredFields) {
      ...
      if (!jsonObj.get("crudType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `crudType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("crudType").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APIAuditLog.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APIAuditLog' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APIAuditLog> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APIAuditLog.class));

       return (TypeAdapter<T>) new TypeAdapter<APIAuditLog>() {
           @Override
           public void write(JsonWriter out, APIAuditLog value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APIAuditLog read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APIAuditLog given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APIAuditLog
   * @throws IOException if the JSON string is invalid with respect to APIAuditLog
   */
  public static APIAuditLog fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APIAuditLog.class);
  }

  /**
   * Convert an instance of APIAuditLog to an JSON string
   *
   * @return JSON string
   */
