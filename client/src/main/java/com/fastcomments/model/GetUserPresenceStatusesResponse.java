...
public class GetUserPresenceStatusesResponse {
  ...
  public GetUserPresenceStatusesResponse status(@javax.annotation.Nonnull APIStatus status) {
    this.status = status;
    return this;
  }
   ...
   * @return the GetUserPresenceStatusesResponse instance itself
   */
  public GetUserPresenceStatusesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, getUserPresenceStatusesResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, getUserPresenceStatusesResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, userIdsOnline, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "userIdsOnline"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("status", "userIdsOnline"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUserPresenceStatusesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetUserPresenceStatusesResponse is not found in the empty JSON string", GetUserPresenceStatusesResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetUserPresenceStatusesResponse>() {
           ...
           public GetUserPresenceStatusesResponse read(JsonReader in) throws IOException {
             ...
             GetUserPresenceStatusesResponse instance = thisAdapter.fromJsonTree(jsonObj);
