...
public class CheckedCommentsForBlocked200Response extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CheckedCommentsForBlocked200Response>() {
                ...
                public void write(JsonWriter out, CheckedCommentsForBlocked200Response value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: CheckBlockedCommentsResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode");
                }
     ...
     * CheckBlockedCommentsResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be CheckBlockedCommentsResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode");
    }
     ...
     * CheckBlockedCommentsResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode
     *
     * @return The actual instance (CheckBlockedCommentsResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for CheckedCommentsForBlocked200Response with anyOf schemas: CheckBlockedCommentsResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
