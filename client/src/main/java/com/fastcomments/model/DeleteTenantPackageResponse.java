...
public class DeleteTenantPackageResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteTenantPackageResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteTenantPackageResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteTenantPackageResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteTenantPackageResponse>() {
                @Override
                public void write(JsonWriter out, DeleteTenantPackageResponse value) throws IOException {
                ...
                @Override
                public DeleteTenantPackageResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteTenantPackageResponse ret = new DeleteTenantPackageResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteTenantPackageResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteTenantPackageResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public DeleteTenantPackageResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteTenantPackageResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteTenantPackageResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteTenantPackageResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteTenantPackageResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteTenantPackageResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteTenantPackageResponse
     */
    public static DeleteTenantPackageResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteTenantPackageResponse.class);
    }

    /**
     * Convert an instance of DeleteTenantPackageResponse to an JSON string
     *
     * @return JSON string
     */
