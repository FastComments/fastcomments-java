...
public class PutCloseThreadResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PutCloseThreadResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PutCloseThreadResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PutCloseThreadResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PutCloseThreadResponse>() {
                @Override
                public void write(JsonWriter out, PutCloseThreadResponse value) throws IOException {
                ...
                @Override
                public PutCloseThreadResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PutCloseThreadResponse ret = new PutCloseThreadResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PutCloseThreadResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PutCloseThreadResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public PutCloseThreadResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PutCloseThreadResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PutCloseThreadResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PutCloseThreadResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PutCloseThreadResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PutCloseThreadResponse
     * @throws IOException if the JSON string is invalid with respect to PutCloseThreadResponse
     */
    public static PutCloseThreadResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PutCloseThreadResponse.class);
    }

    /**
     * Convert an instance of PutCloseThreadResponse to an JSON string
     *
     * @return JSON string
     */
