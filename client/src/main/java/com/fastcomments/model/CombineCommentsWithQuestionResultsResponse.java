...
public class CombineCommentsWithQuestionResultsResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CombineCommentsWithQuestionResultsResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CombineCommentsWithQuestionResultsResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CombineCommentsWithQuestionResultsResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CombineCommentsWithQuestionResultsResponse>() {
                @Override
                public void write(JsonWriter out, CombineCommentsWithQuestionResultsResponse value) throws IOException {
                ...
                @Override
                public CombineCommentsWithQuestionResultsResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CombineCommentsWithQuestionResultsResponse ret = new CombineCommentsWithQuestionResultsResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for CombineQuestionResultsWithCommentsResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CombineCommentsWithQuestionResultsResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CombineCommentsWithQuestionResultsResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public CombineCommentsWithQuestionResultsResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return CombineCommentsWithQuestionResultsResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CombineCommentsWithQuestionResultsResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CombineCommentsWithQuestionResultsResponse with anyOf schemas: APIError, CombineQuestionResultsWithCommentsResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of CombineCommentsWithQuestionResultsResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CombineCommentsWithQuestionResultsResponse
     * @throws IOException if the JSON string is invalid with respect to CombineCommentsWithQuestionResultsResponse
     */
    public static CombineCommentsWithQuestionResultsResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CombineCommentsWithQuestionResultsResponse.class);
    }

    /**
     * Convert an instance of CombineCommentsWithQuestionResultsResponse to an JSON string
     *
     * @return JSON string
     */
