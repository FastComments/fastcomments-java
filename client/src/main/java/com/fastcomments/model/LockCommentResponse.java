...
public class LockCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(LockCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!LockCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'LockCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<LockCommentResponse>() {
                @Override
                public void write(JsonWriter out, LockCommentResponse value) throws IOException {
                ...
                @Override
                public LockCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        LockCommentResponse ret = new LockCommentResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for LockCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public LockCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return LockCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to LockCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for LockCommentResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of LockCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of LockCommentResponse
     * @throws IOException if the JSON string is invalid with respect to LockCommentResponse
     */
    public static LockCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, LockCommentResponse.class);
    }

    /**
     * Convert an instance of LockCommentResponse to an JSON string
     *
     * @return JSON string
     */
