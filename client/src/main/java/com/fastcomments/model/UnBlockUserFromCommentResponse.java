...
public class UnBlockUserFromCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UnBlockUserFromCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UnBlockUserFromCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UnBlockUserFromCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UnBlockUserFromCommentResponse>() {
                @Override
                public void write(JsonWriter out, UnBlockUserFromCommentResponse value) throws IOException {
                ...
                @Override
                public UnBlockUserFromCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UnBlockUserFromCommentResponse ret = new UnBlockUserFromCommentResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for UnblockSuccess failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UnBlockUserFromCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UnBlockUserFromCommentResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UnBlockUserFromCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UnBlockUserFromCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UnBlockUserFromCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UnBlockUserFromCommentResponse with anyOf schemas: APIError, UnblockSuccess. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UnBlockUserFromCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UnBlockUserFromCommentResponse
     * @throws IOException if the JSON string is invalid with respect to UnBlockUserFromCommentResponse
     */
    public static UnBlockUserFromCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UnBlockUserFromCommentResponse.class);
    }

    /**
     * Convert an instance of UnBlockUserFromCommentResponse to an JSON string
     *
     * @return JSON string
     */
