...
public class PostVoteResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PostVoteResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostVoteResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostVoteResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PostVoteResponse>() {
                @Override
                public void write(JsonWriter out, PostVoteResponse value) throws IOException {
                ...
                @Override
                public PostVoteResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PostVoteResponse ret = new PostVoteResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PostVoteResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PostVoteResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public PostVoteResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PostVoteResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostVoteResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PostVoteResponse with anyOf schemas: APIError, VoteResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PostVoteResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostVoteResponse
     * @throws IOException if the JSON string is invalid with respect to PostVoteResponse
     */
    public static PostVoteResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostVoteResponse.class);
    }

    /**
     * Convert an instance of PostVoteResponse to an JSON string
     *
     * @return JSON string
     */
