...
public class GetGlobalEventLogResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetGlobalEventLogResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetGlobalEventLogResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetGlobalEventLogResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetGlobalEventLogResponse>() {
                @Override
                public void write(JsonWriter out, GetGlobalEventLogResponse value) throws IOException {
                ...
                @Override
                public GetGlobalEventLogResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        GetGlobalEventLogResponse ret = new GetGlobalEventLogResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for GetEventLogResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetGlobalEventLogResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetGlobalEventLogResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public GetGlobalEventLogResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetGlobalEventLogResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetGlobalEventLogResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for GetGlobalEventLogResponse with anyOf schemas: APIError, GetEventLogResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GetGlobalEventLogResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetGlobalEventLogResponse
     * @throws IOException if the JSON string is invalid with respect to GetGlobalEventLogResponse
     */
    public static GetGlobalEventLogResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetGlobalEventLogResponse.class);
    }

    /**
     * Convert an instance of GetGlobalEventLogResponse to an JSON string
     *
     * @return JSON string
     */
