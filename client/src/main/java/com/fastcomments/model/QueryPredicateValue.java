...
public class QueryPredicateValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(QueryPredicateValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!QueryPredicateValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'QueryPredicateValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<QueryPredicateValue>() {
                @Override
                public void write(JsonWriter out, QueryPredicateValue value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: Boolean, Double, String");
                }

                @Override
                public QueryPredicateValue read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        QueryPredicateValue ret = new QueryPredicateValue();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for QueryPredicateValue: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public QueryPredicateValue() {
        super("anyOf", Boolean.FALSE);
    }

    public QueryPredicateValue(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return QueryPredicateValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to QueryPredicateValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for QueryPredicateValue with anyOf schemas: Boolean, Double, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of QueryPredicateValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of QueryPredicateValue
     * @throws IOException if the JSON string is invalid with respect to QueryPredicateValue
     */
    public static QueryPredicateValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, QueryPredicateValue.class);
    }

    /**
     * Convert an instance of QueryPredicateValue to an JSON string
     *
     * @return JSON string
     */
