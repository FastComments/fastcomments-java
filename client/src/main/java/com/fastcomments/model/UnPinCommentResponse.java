...
public class UnPinCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UnPinCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UnPinCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UnPinCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UnPinCommentResponse>() {
                @Override
                public void write(JsonWriter out, UnPinCommentResponse value) throws IOException {
                ...
                @Override
                public UnPinCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChangeCommentPinStatusResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UnPinCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UnPinCommentResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UnPinCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UnPinCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UnPinCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UnPinCommentResponse with anyOf schemas: APIError, ChangeCommentPinStatusResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UnPinCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UnPinCommentResponse
     * @throws IOException if the JSON string is invalid with respect to UnPinCommentResponse
     */
    public static UnPinCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UnPinCommentResponse.class);
    }

    /**
     * Convert an instance of UnPinCommentResponse to an JSON string
     *
     * @return JSON string
     */
