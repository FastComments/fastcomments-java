...
public class GetCommentsPublicResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetCommentsPublicResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetCommentsPublicResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetCommentsPublicResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetCommentsPublicResponse>() {
                @Override
                public void write(JsonWriter out, GetCommentsPublicResponse value) throws IOException {
                ...
                @Override
                public GetCommentsPublicResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        GetCommentsPublicResponse ret = new GetCommentsPublicResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetCommentsPublicResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetCommentsPublicResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public GetCommentsPublicResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetCommentsPublicResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetCommentsPublicResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for GetCommentsPublicResponse with anyOf schemas: APIError, GetCommentsResponseWithPresencePublicComment. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GetCommentsPublicResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetCommentsPublicResponse
     * @throws IOException if the JSON string is invalid with respect to GetCommentsPublicResponse
     */
    public static GetCommentsPublicResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetCommentsPublicResponse.class);
    }

    /**
     * Convert an instance of GetCommentsPublicResponse to an JSON string
     *
     * @return JSON string
     */
