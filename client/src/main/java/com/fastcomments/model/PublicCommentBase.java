...
public class PublicCommentBase {
  ...
  public PublicCommentBase() {
  }

  public PublicCommentBase id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public PublicCommentBase userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public PublicCommentBase commenterName(@javax.annotation.Nonnull String commenterName) {
  ...
  public PublicCommentBase commenterLink(@javax.annotation.Nullable String commenterLink) {
  ...
  public PublicCommentBase commentHTML(@javax.annotation.Nonnull String commentHTML) {
  ...
  public PublicCommentBase parentId(@javax.annotation.Nullable String parentId) {
  ...
  public PublicCommentBase date(@javax.annotation.Nullable OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public PublicCommentBase votes(@javax.annotation.Nullable Integer votes) {
    this.votes = votes;
    return this;
  }
  ...
  public PublicCommentBase votesUp(@javax.annotation.Nullable Integer votesUp) {
  ...
  public PublicCommentBase votesDown(@javax.annotation.Nullable Integer votesDown) {
  ...
  public PublicCommentBase verified(@javax.annotation.Nonnull Boolean verified) {
  ...
  public PublicCommentBase avatarSrc(@javax.annotation.Nullable String avatarSrc) {
  ...
  public PublicCommentBase hasImages(@javax.annotation.Nullable Boolean hasImages) {
  ...
  public PublicCommentBase isByAdmin(@javax.annotation.Nullable Boolean isByAdmin) {
  ...
  public PublicCommentBase isByModerator(@javax.annotation.Nullable Boolean isByModerator) {
  ...
  public PublicCommentBase isPinned(@javax.annotation.Nullable Boolean isPinned) {
  ...
  public PublicCommentBase isLocked(@javax.annotation.Nullable Boolean isLocked) {
  ...
  public PublicCommentBase displayLabel(@javax.annotation.Nullable String displayLabel) {
  ...
  public PublicCommentBase rating(@javax.annotation.Nullable Double rating) {
    this.rating = rating;
    return this;
  }
  ...
  public PublicCommentBase badges(@javax.annotation.Nullable List<CommentUserBadgeInfo> badges) {
    this.badges = badges;
    return this;
  }

  public PublicCommentBase addBadgesItem(CommentUserBadgeInfo badgesItem) {
    if (this.badges == null) {
  ...
  public PublicCommentBase viewCount(@javax.annotation.Nullable Long viewCount) {
  ...
  public PublicCommentBase isDeleted(@javax.annotation.Nullable Boolean isDeleted) {
  ...
  public PublicCommentBase isDeletedUser(@javax.annotation.Nullable Boolean isDeletedUser) {
  ...
  public PublicCommentBase isSpam(@javax.annotation.Nullable Boolean isSpam) {
    this.isSpam = isSpam;
    return this;
  }
  ...
  public PublicCommentBase anonUserId(@javax.annotation.Nullable String anonUserId) {
  ...
  public PublicCommentBase feedbackIds(@javax.annotation.Nullable List<String> feedbackIds) {
    this.feedbackIds = feedbackIds;
    return this;
  }

  public PublicCommentBase addFeedbackIdsItem(String feedbackIdsItem) {
  ...
  public PublicCommentBase requiresVerification(@javax.annotation.Nullable Boolean requiresVerification) {
  ...
  public PublicCommentBase editKey(@javax.annotation.Nullable String editKey) {
  ...
  public PublicCommentBase approved(@javax.annotation.Nullable Boolean approved) {
  ...
  public boolean equals(Object o) {
    ...
    PublicCommentBase publicCommentBase = (PublicCommentBase) o;
    return Objects.equals(this.id, publicCommentBase.id) &&
        Objects.equals(this.userId, publicCommentBase.userId) &&
        Objects.equals(this.commenterName, publicCommentBase.commenterName) &&
        Objects.equals(this.commenterLink, publicCommentBase.commenterLink) &&
        Objects.equals(this.commentHTML, publicCommentBase.commentHTML) &&
        Objects.equals(this.parentId, publicCommentBase.parentId) &&
        Objects.equals(this.date, publicCommentBase.date) &&
        Objects.equals(this.votes, publicCommentBase.votes) &&
        Objects.equals(this.votesUp, publicCommentBase.votesUp) &&
        Objects.equals(this.votesDown, publicCommentBase.votesDown) &&
        Objects.equals(this.verified, publicCommentBase.verified) &&
        Objects.equals(this.avatarSrc, publicCommentBase.avatarSrc) &&
        Objects.equals(this.hasImages, publicCommentBase.hasImages) &&
        Objects.equals(this.isByAdmin, publicCommentBase.isByAdmin) &&
        Objects.equals(this.isByModerator, publicCommentBase.isByModerator) &&
        Objects.equals(this.isPinned, publicCommentBase.isPinned) &&
        Objects.equals(this.isLocked, publicCommentBase.isLocked) &&
        Objects.equals(this.displayLabel, publicCommentBase.displayLabel) &&
        Objects.equals(this.rating, publicCommentBase.rating) &&
        Objects.equals(this.badges, publicCommentBase.badges) &&
        Objects.equals(this.viewCount, publicCommentBase.viewCount) &&
        Objects.equals(this.isDeleted, publicCommentBase.isDeleted) &&
        Objects.equals(this.isDeletedUser, publicCommentBase.isDeletedUser) &&
        Objects.equals(this.isSpam, publicCommentBase.isSpam) &&
        Objects.equals(this.anonUserId, publicCommentBase.anonUserId) &&
        Objects.equals(this.feedbackIds, publicCommentBase.feedbackIds) &&
        Objects.equals(this.requiresVerification, publicCommentBase.requiresVerification) &&
        Objects.equals(this.editKey, publicCommentBase.editKey) &&
        Objects.equals(this.approved, publicCommentBase.approved);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, userId, commenterName, commenterLink, commentHTML, parentId, date, votes, votesUp, votesDown, verified, avatarSrc, hasImages, isByAdmin, isByModerator, isPinned, isLocked, displayLabel, rating, badges, viewCount, isDeleted, isDeletedUser, isSpam, anonUserId, feedbackIds, requiresVerification, editKey, approved);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PublicCommentBase {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "userId", "commenterName", "commenterLink", "commentHTML", "parentId", "date", "votes", "votesUp", "votesDown", "verified", "avatarSrc", "hasImages", "isByAdmin", "isByModerator", "isPinned", "isLocked", "displayLabel", "rating", "badges", "viewCount", "isDeleted", "isDeletedUser", "isSpam", "anonUserId", "feedbackIds", "requiresVerification", "editKey", "approved"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to PublicCommentBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublicCommentBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PublicCommentBase is not found in the empty JSON string", PublicCommentBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublicCommentBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PublicCommentBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PublicCommentBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublicCommentBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublicCommentBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PublicCommentBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PublicCommentBase.class));

       return (TypeAdapter<T>) new TypeAdapter<PublicCommentBase>() {
           @Override
           public void write(JsonWriter out, PublicCommentBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PublicCommentBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PublicCommentBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PublicCommentBase
   * @throws IOException if the JSON string is invalid with respect to PublicCommentBase
   */
  public static PublicCommentBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PublicCommentBase.class);
  }

  /**
   * Convert an instance of PublicCommentBase to an JSON string
   *
   * @return JSON string
   */
