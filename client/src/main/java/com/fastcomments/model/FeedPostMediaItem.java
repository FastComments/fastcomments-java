...
public class FeedPostMediaItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("title", "linkUrl", "sizes"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sizes"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeedPostMediaItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FeedPostMediaItem is not found in the empty JSON string", FeedPostMediaItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FeedPostMediaItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FeedPostMediaItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
