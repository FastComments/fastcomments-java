...
public class PostFlagCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PostFlagCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostFlagCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostFlagCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PostFlagCommentResponse>() {
                @Override
                public void write(JsonWriter out, PostFlagCommentResponse value) throws IOException {
                ...
                @Override
                public PostFlagCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PostFlagCommentResponse ret = new PostFlagCommentResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PostFlagCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PostFlagCommentResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public PostFlagCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PostFlagCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostFlagCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PostFlagCommentResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PostFlagCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostFlagCommentResponse
     * @throws IOException if the JSON string is invalid with respect to PostFlagCommentResponse
     */
    public static PostFlagCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostFlagCommentResponse.class);
    }

    /**
     * Convert an instance of PostFlagCommentResponse to an JSON string
     *
     * @return JSON string
     */
