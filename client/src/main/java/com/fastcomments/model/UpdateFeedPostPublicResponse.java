...
public class UpdateFeedPostPublicResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateFeedPostPublicResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateFeedPostPublicResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateFeedPostPublicResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateFeedPostPublicResponse>() {
                @Override
                public void write(JsonWriter out, UpdateFeedPostPublicResponse value) throws IOException {
                ...
                @Override
                public UpdateFeedPostPublicResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateFeedPostPublicResponse ret = new UpdateFeedPostPublicResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateFeedPostPublicResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateFeedPostPublicResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UpdateFeedPostPublicResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateFeedPostPublicResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateFeedPostPublicResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateFeedPostPublicResponse with anyOf schemas: APIError, CreateFeedPostResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateFeedPostPublicResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateFeedPostPublicResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateFeedPostPublicResponse
     */
    public static UpdateFeedPostPublicResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateFeedPostPublicResponse.class);
    }

    /**
     * Convert an instance of UpdateFeedPostPublicResponse to an JSON string
     *
     * @return JSON string
     */
