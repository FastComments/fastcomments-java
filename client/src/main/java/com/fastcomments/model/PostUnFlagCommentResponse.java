...
public class PostUnFlagCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PostUnFlagCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostUnFlagCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostUnFlagCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PostUnFlagCommentResponse>() {
                @Override
                public void write(JsonWriter out, PostUnFlagCommentResponse value) throws IOException {
                ...
                @Override
                public PostUnFlagCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PostUnFlagCommentResponse ret = new PostUnFlagCommentResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PostUnFlagCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PostUnFlagCommentResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public PostUnFlagCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PostUnFlagCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostUnFlagCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PostUnFlagCommentResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PostUnFlagCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostUnFlagCommentResponse
     * @throws IOException if the JSON string is invalid with respect to PostUnFlagCommentResponse
     */
    public static PostUnFlagCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostUnFlagCommentResponse.class);
    }

    /**
     * Convert an instance of PostUnFlagCommentResponse to an JSON string
     *
     * @return JSON string
     */
