...
public class GetEventLog200Response extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetEventLog200Response>() {
                ...
                public void write(JsonWriter out, GetEventLog200Response value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: GetEventLogResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode");
                }
     ...
     * GetEventLogResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be GetEventLogResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode");
    }
     ...
     * GetEventLogResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode
     *
     * @return The actual instance (GetEventLogResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for GetEventLog200Response with anyOf schemas: GetEventLogResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
