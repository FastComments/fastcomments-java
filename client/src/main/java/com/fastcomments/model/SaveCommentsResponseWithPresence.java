...
public class SaveCommentsResponseWithPresence {
   ...
   * @return the SaveCommentsResponseWithPresence instance itself
   */
  public SaveCommentsResponseWithPresence putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, saveCommentsResponseWithPresence.status) &&
        ...
        Objects.equals(this.additionalProperties, saveCommentsResponseWithPresence.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, comment, user, moduleData, userIdWS, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "comment", "user", "moduleData", "userIdWS"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SaveCommentsResponseWithPresence.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SaveCommentsResponseWithPresence is not found in the empty JSON string", SaveCommentsResponseWithPresence.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SaveCommentsResponseWithPresence>() {
           ...
           public SaveCommentsResponseWithPresence read(JsonReader in) throws IOException {
             ...
             SaveCommentsResponseWithPresence instance = thisAdapter.fromJsonTree(jsonObj);
