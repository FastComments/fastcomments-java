...
public class GetFeedPostsPublicResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetFeedPostsPublicResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFeedPostsPublicResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetFeedPostsPublicResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetFeedPostsPublicResponse>() {
                @Override
                public void write(JsonWriter out, GetFeedPostsPublicResponse value) throws IOException {
                ...
                @Override
                public GetFeedPostsPublicResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        GetFeedPostsPublicResponse ret = new GetFeedPostsPublicResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for PublicFeedPostsResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetFeedPostsPublicResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetFeedPostsPublicResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetFeedPostsPublicResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetFeedPostsPublicResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for GetFeedPostsPublicResponse with anyOf schemas: APIError, PublicFeedPostsResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GetFeedPostsPublicResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetFeedPostsPublicResponse
     * @throws IOException if the JSON string is invalid with respect to GetFeedPostsPublicResponse
     */
    public static GetFeedPostsPublicResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetFeedPostsPublicResponse.class);
    }

    /**
     * Convert an instance of GetFeedPostsPublicResponse to an JSON string
     *
     * @return JSON string
     */
