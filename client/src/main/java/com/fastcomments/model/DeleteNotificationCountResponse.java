...
public class DeleteNotificationCountResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteNotificationCountResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteNotificationCountResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteNotificationCountResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteNotificationCountResponse>() {
                @Override
                public void write(JsonWriter out, DeleteNotificationCountResponse value) throws IOException {
                ...
                @Override
                public DeleteNotificationCountResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteNotificationCountResponse ret = new DeleteNotificationCountResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteNotificationCountResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteNotificationCountResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public DeleteNotificationCountResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteNotificationCountResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteNotificationCountResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteNotificationCountResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteNotificationCountResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteNotificationCountResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteNotificationCountResponse
     */
    public static DeleteNotificationCountResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteNotificationCountResponse.class);
    }

    /**
     * Convert an instance of DeleteNotificationCountResponse to an JSON string
     *
     * @return JSON string
     */
