...
public class PickAPICommentUpdatableCommentFields {
   ...
   * @return the PickAPICommentUpdatableCommentFields instance itself
   */
  public PickAPICommentUpdatableCommentFields putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, pickAPICommentUpdatableCommentFields.date) &&
        ...
        Objects.equals(this.additionalProperties, pickAPICommentUpdatableCommentFields.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, urlId, urlIdRaw, url, pageTitle, userId, commenterEmail, commenterName, commenterLink, comment, commentHTML, parentId, localDateString, localDateHours, votes, votesUp, votesDown, expireAt, verified, verifiedDate, notificationSentForParent, notificationSentForParentTenant, reviewed, externalId, externalParentId, avatarSrc, isSpam, approved, isDeleted, isDeletedUser, isByAdmin, isByModerator, isPinned, isLocked, flagCount, displayLabel, meta, moderationGroupIds, feedbackIds, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PickAPICommentUpdatableCommentFields>() {
           ...
           public PickAPICommentUpdatableCommentFields read(JsonReader in) throws IOException {
             ...
             PickAPICommentUpdatableCommentFields instance = thisAdapter.fromJsonTree(jsonObj);
