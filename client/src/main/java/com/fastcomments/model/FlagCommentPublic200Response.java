...
public class FlagCommentPublic200Response extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(FlagCommentPublic200Response.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FlagCommentPublic200Response.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FlagCommentPublic200Response' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<FlagCommentPublic200Response>() {
                @Override
                public void write(JsonWriter out, FlagCommentPublic200Response value) throws IOException {
                ...
                @Override
                public FlagCommentPublic200Response read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        FlagCommentPublic200Response ret = new FlagCommentPublic200Response();
                    ...
                    throw new IOException(String.format("Failed deserialization for FlagCommentPublic200Response: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public FlagCommentPublic200Response(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return FlagCommentPublic200Response.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to FlagCommentPublic200Response
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for FlagCommentPublic200Response with anyOf schemas: APIEmptyResponse, PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of FlagCommentPublic200Response given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FlagCommentPublic200Response
     * @throws IOException if the JSON string is invalid with respect to FlagCommentPublic200Response
     */
    public static FlagCommentPublic200Response fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FlagCommentPublic200Response.class);
    }

    /**
     * Convert an instance of FlagCommentPublic200Response to an JSON string
     *
     * @return JSON string
     */
