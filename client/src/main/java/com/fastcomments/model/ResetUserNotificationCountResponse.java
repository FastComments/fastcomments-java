...
public class ResetUserNotificationCountResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ResetUserNotificationCountResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ResetUserNotificationCountResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ResetUserNotificationCountResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ResetUserNotificationCountResponse>() {
                @Override
                public void write(JsonWriter out, ResetUserNotificationCountResponse value) throws IOException {
                ...
                @Override
                public ResetUserNotificationCountResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ResetUserNotificationCountResponse ret = new ResetUserNotificationCountResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ResetUserNotificationsResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ResetUserNotificationCountResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ResetUserNotificationCountResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public ResetUserNotificationCountResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ResetUserNotificationCountResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ResetUserNotificationCountResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ResetUserNotificationCountResponse with anyOf schemas: APIError, ResetUserNotificationsResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of ResetUserNotificationCountResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ResetUserNotificationCountResponse
     * @throws IOException if the JSON string is invalid with respect to ResetUserNotificationCountResponse
     */
    public static ResetUserNotificationCountResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ResetUserNotificationCountResponse.class);
    }

    /**
     * Convert an instance of ResetUserNotificationCountResponse to an JSON string
     *
     * @return JSON string
     */
