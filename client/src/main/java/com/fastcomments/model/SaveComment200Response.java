...
public class SaveComment200Response extends AbstractOpenApiSchema {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for SaveComment200Response with anyOf schemas: APIError, SaveCommentResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
