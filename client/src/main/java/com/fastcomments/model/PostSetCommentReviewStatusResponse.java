...
public class PostSetCommentReviewStatusResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PostSetCommentReviewStatusResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostSetCommentReviewStatusResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostSetCommentReviewStatusResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PostSetCommentReviewStatusResponse>() {
                @Override
                public void write(JsonWriter out, PostSetCommentReviewStatusResponse value) throws IOException {
                ...
                @Override
                public PostSetCommentReviewStatusResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PostSetCommentReviewStatusResponse ret = new PostSetCommentReviewStatusResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PostSetCommentReviewStatusResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PostSetCommentReviewStatusResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PostSetCommentReviewStatusResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostSetCommentReviewStatusResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PostSetCommentReviewStatusResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PostSetCommentReviewStatusResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostSetCommentReviewStatusResponse
     * @throws IOException if the JSON string is invalid with respect to PostSetCommentReviewStatusResponse
     */
    public static PostSetCommentReviewStatusResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostSetCommentReviewStatusResponse.class);
    }

    /**
     * Convert an instance of PostSetCommentReviewStatusResponse to an JSON string
     *
     * @return JSON string
     */
