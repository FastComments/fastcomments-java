...
public class ReplaceTenantUserResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ReplaceTenantUserResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ReplaceTenantUserResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ReplaceTenantUserResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ReplaceTenantUserResponse>() {
                @Override
                public void write(JsonWriter out, ReplaceTenantUserResponse value) throws IOException {
                ...
                @Override
                public ReplaceTenantUserResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ReplaceTenantUserResponse ret = new ReplaceTenantUserResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ReplaceTenantUserResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ReplaceTenantUserResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public ReplaceTenantUserResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ReplaceTenantUserResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ReplaceTenantUserResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ReplaceTenantUserResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of ReplaceTenantUserResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ReplaceTenantUserResponse
     * @throws IOException if the JSON string is invalid with respect to ReplaceTenantUserResponse
     */
    public static ReplaceTenantUserResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ReplaceTenantUserResponse.class);
    }

    /**
     * Convert an instance of ReplaceTenantUserResponse to an JSON string
     *
     * @return JSON string
     */
