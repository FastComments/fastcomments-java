...
public class APICommentBase {
  ...
  public APICommentBase() {
  }

  public APICommentBase id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public APICommentBase aiDeterminedSpam(@javax.annotation.Nullable Boolean aiDeterminedSpam) {
  ...
  public APICommentBase anonUserId(@javax.annotation.Nullable String anonUserId) {
  ...
  public APICommentBase approved(@javax.annotation.Nonnull Boolean approved) {
  ...
  public APICommentBase avatarSrc(@javax.annotation.Nullable String avatarSrc) {
  ...
  public APICommentBase badges(@javax.annotation.Nullable List<CommentUserBadgeInfo> badges) {
    this.badges = badges;
    return this;
  }

  public APICommentBase addBadgesItem(CommentUserBadgeInfo badgesItem) {
    if (this.badges == null) {
  ...
  public APICommentBase comment(@javax.annotation.Nonnull String comment) {
  ...
  public APICommentBase commentHTML(@javax.annotation.Nonnull String commentHTML) {
  ...
  public APICommentBase commenterEmail(@javax.annotation.Nullable String commenterEmail) {
  ...
  public APICommentBase commenterLink(@javax.annotation.Nullable String commenterLink) {
  ...
  public APICommentBase commenterName(@javax.annotation.Nonnull String commenterName) {
  ...
  public APICommentBase date(@javax.annotation.Nullable OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public APICommentBase displayLabel(@javax.annotation.Nullable String displayLabel) {
  ...
  public APICommentBase domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public APICommentBase externalId(@javax.annotation.Nullable String externalId) {
  ...
  public APICommentBase externalParentId(@javax.annotation.Nullable String externalParentId) {
  ...
  public APICommentBase expireAt(@javax.annotation.Nullable OffsetDateTime expireAt) {
  ...
  public APICommentBase feedbackIds(@javax.annotation.Nullable List<String> feedbackIds) {
    this.feedbackIds = feedbackIds;
    return this;
  }

  public APICommentBase addFeedbackIdsItem(String feedbackIdsItem) {
  ...
  public APICommentBase flagCount(@javax.annotation.Nullable Integer flagCount) {
  ...
  public APICommentBase fromProductId(@javax.annotation.Nullable Integer fromProductId) {
  ...
  public APICommentBase hasCode(@javax.annotation.Nullable Boolean hasCode) {
  ...
  public APICommentBase hasImages(@javax.annotation.Nullable Boolean hasImages) {
  ...
  public APICommentBase hasLinks(@javax.annotation.Nullable Boolean hasLinks) {
  ...
  public APICommentBase hashTags(@javax.annotation.Nullable List<CommentUserHashTagInfo> hashTags) {
    this.hashTags = hashTags;
    return this;
  }

  public APICommentBase addHashTagsItem(CommentUserHashTagInfo hashTagsItem) {
  ...
  public APICommentBase isByAdmin(@javax.annotation.Nullable Boolean isByAdmin) {
  ...
  public APICommentBase isByModerator(@javax.annotation.Nullable Boolean isByModerator) {
  ...
  public APICommentBase isDeleted(@javax.annotation.Nullable Boolean isDeleted) {
  ...
  public APICommentBase isDeletedUser(@javax.annotation.Nullable Boolean isDeletedUser) {
  ...
  public APICommentBase isPinned(@javax.annotation.Nullable Boolean isPinned) {
  ...
  public APICommentBase isLocked(@javax.annotation.Nullable Boolean isLocked) {
  ...
  public APICommentBase isSpam(@javax.annotation.Nullable Boolean isSpam) {
    this.isSpam = isSpam;
    return this;
  }
  ...
  public APICommentBase localDateHours(@javax.annotation.Nullable Integer localDateHours) {
  ...
  public APICommentBase localDateString(@javax.annotation.Nullable String localDateString) {
  ...
  public APICommentBase locale(@javax.annotation.Nullable String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public APICommentBase mentions(@javax.annotation.Nullable List<CommentUserMentionInfo> mentions) {
    this.mentions = mentions;
    return this;
  }

  public APICommentBase addMentionsItem(CommentUserMentionInfo mentionsItem) {
  ...
  public APICommentBase meta(@javax.annotation.Nullable APICommentBaseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public APICommentBase moderationGroupIds(@javax.annotation.Nullable List<String> moderationGroupIds) {
    this.moderationGroupIds = moderationGroupIds;
    return this;
  }

  public APICommentBase addModerationGroupIdsItem(String moderationGroupIdsItem) {
  ...
  public APICommentBase notificationSentForParent(@javax.annotation.Nullable Boolean notificationSentForParent) {
  ...
  public APICommentBase notificationSentForParentTenant(@javax.annotation.Nullable Boolean notificationSentForParentTenant) {
  ...
  public APICommentBase pageTitle(@javax.annotation.Nullable String pageTitle) {
  ...
  public APICommentBase parentId(@javax.annotation.Nullable String parentId) {
  ...
  public APICommentBase rating(@javax.annotation.Nullable Double rating) {
    this.rating = rating;
    return this;
  }
  ...
  public APICommentBase reviewed(@javax.annotation.Nullable Boolean reviewed) {
  ...
  public APICommentBase tenantId(@javax.annotation.Nonnull String tenantId) {
  ...
  public APICommentBase url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public APICommentBase urlId(@javax.annotation.Nonnull String urlId) {
    this.urlId = urlId;
    return this;
  }
  ...
  public APICommentBase urlIdRaw(@javax.annotation.Nullable String urlIdRaw) {
  ...
  public APICommentBase userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public APICommentBase verified(@javax.annotation.Nonnull Boolean verified) {
  ...
  public APICommentBase verifiedDate(@javax.annotation.Nullable OffsetDateTime verifiedDate) {
  ...
  public APICommentBase votes(@javax.annotation.Nullable Integer votes) {
    this.votes = votes;
    return this;
  }
  ...
  public APICommentBase votesDown(@javax.annotation.Nullable Integer votesDown) {
  ...
  public APICommentBase votesUp(@javax.annotation.Nullable Integer votesUp) {
  ...
  public boolean equals(Object o) {
    ...
    APICommentBase apICommentBase = (APICommentBase) o;
    return Objects.equals(this.id, apICommentBase.id) &&
        Objects.equals(this.aiDeterminedSpam, apICommentBase.aiDeterminedSpam) &&
        Objects.equals(this.anonUserId, apICommentBase.anonUserId) &&
        Objects.equals(this.approved, apICommentBase.approved) &&
        Objects.equals(this.avatarSrc, apICommentBase.avatarSrc) &&
        Objects.equals(this.badges, apICommentBase.badges) &&
        Objects.equals(this.comment, apICommentBase.comment) &&
        Objects.equals(this.commentHTML, apICommentBase.commentHTML) &&
        Objects.equals(this.commenterEmail, apICommentBase.commenterEmail) &&
        Objects.equals(this.commenterLink, apICommentBase.commenterLink) &&
        Objects.equals(this.commenterName, apICommentBase.commenterName) &&
        Objects.equals(this.date, apICommentBase.date) &&
        Objects.equals(this.displayLabel, apICommentBase.displayLabel) &&
        Objects.equals(this.domain, apICommentBase.domain) &&
        Objects.equals(this.externalId, apICommentBase.externalId) &&
        Objects.equals(this.externalParentId, apICommentBase.externalParentId) &&
        Objects.equals(this.expireAt, apICommentBase.expireAt) &&
        Objects.equals(this.feedbackIds, apICommentBase.feedbackIds) &&
        Objects.equals(this.flagCount, apICommentBase.flagCount) &&
        Objects.equals(this.fromProductId, apICommentBase.fromProductId) &&
        Objects.equals(this.hasCode, apICommentBase.hasCode) &&
        Objects.equals(this.hasImages, apICommentBase.hasImages) &&
        Objects.equals(this.hasLinks, apICommentBase.hasLinks) &&
        Objects.equals(this.hashTags, apICommentBase.hashTags) &&
        Objects.equals(this.isByAdmin, apICommentBase.isByAdmin) &&
        Objects.equals(this.isByModerator, apICommentBase.isByModerator) &&
        Objects.equals(this.isDeleted, apICommentBase.isDeleted) &&
        Objects.equals(this.isDeletedUser, apICommentBase.isDeletedUser) &&
        Objects.equals(this.isPinned, apICommentBase.isPinned) &&
        Objects.equals(this.isLocked, apICommentBase.isLocked) &&
        Objects.equals(this.isSpam, apICommentBase.isSpam) &&
        Objects.equals(this.localDateHours, apICommentBase.localDateHours) &&
        Objects.equals(this.localDateString, apICommentBase.localDateString) &&
        Objects.equals(this.locale, apICommentBase.locale) &&
        Objects.equals(this.mentions, apICommentBase.mentions) &&
        Objects.equals(this.meta, apICommentBase.meta) &&
        Objects.equals(this.moderationGroupIds, apICommentBase.moderationGroupIds) &&
        Objects.equals(this.notificationSentForParent, apICommentBase.notificationSentForParent) &&
        Objects.equals(this.notificationSentForParentTenant, apICommentBase.notificationSentForParentTenant) &&
        Objects.equals(this.pageTitle, apICommentBase.pageTitle) &&
        Objects.equals(this.parentId, apICommentBase.parentId) &&
        Objects.equals(this.rating, apICommentBase.rating) &&
        Objects.equals(this.reviewed, apICommentBase.reviewed) &&
        Objects.equals(this.tenantId, apICommentBase.tenantId) &&
        Objects.equals(this.url, apICommentBase.url) &&
        Objects.equals(this.urlId, apICommentBase.urlId) &&
        Objects.equals(this.urlIdRaw, apICommentBase.urlIdRaw) &&
        Objects.equals(this.userId, apICommentBase.userId) &&
        Objects.equals(this.verified, apICommentBase.verified) &&
        Objects.equals(this.verifiedDate, apICommentBase.verifiedDate) &&
        Objects.equals(this.votes, apICommentBase.votes) &&
        Objects.equals(this.votesDown, apICommentBase.votesDown) &&
        Objects.equals(this.votesUp, apICommentBase.votesUp);
  }
  ...
  public String toString() {
    ...
    sb.append("class APICommentBase {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to APICommentBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APICommentBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in APICommentBase is not found in the empty JSON string", APICommentBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APICommentBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `APICommentBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : APICommentBase.openapiRequiredFields) {
      ...
      if ((jsonObj.get("externalParentId") != null && !jsonObj.get("externalParentId").isJsonNull()) && !jsonObj.get("externalParentId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `externalParentId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("externalParentId").toString()));
      }
      ...
      if ((jsonObj.get("urlIdRaw") != null && !jsonObj.get("urlIdRaw").isJsonNull()) && !jsonObj.get("urlIdRaw").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `urlIdRaw` to be a primitive type in the JSON string but got `%s`", jsonObj.get("urlIdRaw").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APICommentBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APICommentBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APICommentBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APICommentBase.class));

       return (TypeAdapter<T>) new TypeAdapter<APICommentBase>() {
           @Override
           public void write(JsonWriter out, APICommentBase value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APICommentBase read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APICommentBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APICommentBase
   * @throws IOException if the JSON string is invalid with respect to APICommentBase
   */
  public static APICommentBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APICommentBase.class);
  }

  /**
   * Convert an instance of APICommentBase to an JSON string
   *
   * @return JSON string
   */
