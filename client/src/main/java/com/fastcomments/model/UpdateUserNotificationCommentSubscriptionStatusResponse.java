...
public class UpdateUserNotificationCommentSubscriptionStatusResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateUserNotificationCommentSubscriptionStatusResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateUserNotificationCommentSubscriptionStatusResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateUserNotificationCommentSubscriptionStatusResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateUserNotificationCommentSubscriptionStatusResponse>() {
                @Override
                public void write(JsonWriter out, UpdateUserNotificationCommentSubscriptionStatusResponse value) throws IOException {
                ...
                @Override
                public UpdateUserNotificationCommentSubscriptionStatusResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateUserNotificationCommentSubscriptionStatusResponse ret = new UpdateUserNotificationCommentSubscriptionStatusResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateUserNotificationCommentSubscriptionStatusResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateUserNotificationCommentSubscriptionStatusResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UpdateUserNotificationCommentSubscriptionStatusResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateUserNotificationCommentSubscriptionStatusResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateUserNotificationCommentSubscriptionStatusResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateUserNotificationCommentSubscriptionStatusResponse with anyOf schemas: IgnoredResponse, UserNotificationWriteResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateUserNotificationCommentSubscriptionStatusResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateUserNotificationCommentSubscriptionStatusResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateUserNotificationCommentSubscriptionStatusResponse
     */
    public static UpdateUserNotificationCommentSubscriptionStatusResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateUserNotificationCommentSubscriptionStatusResponse.class);
    }

    /**
     * Convert an instance of UpdateUserNotificationCommentSubscriptionStatusResponse to an JSON string
     *
     * @return JSON string
     */
