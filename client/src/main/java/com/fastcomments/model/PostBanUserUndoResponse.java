...
public class PostBanUserUndoResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PostBanUserUndoResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostBanUserUndoResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostBanUserUndoResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PostBanUserUndoResponse>() {
                @Override
                public void write(JsonWriter out, PostBanUserUndoResponse value) throws IOException {
                ...
                @Override
                public PostBanUserUndoResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PostBanUserUndoResponse ret = new PostBanUserUndoResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PostBanUserUndoResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PostBanUserUndoResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public PostBanUserUndoResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PostBanUserUndoResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostBanUserUndoResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PostBanUserUndoResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PostBanUserUndoResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostBanUserUndoResponse
     * @throws IOException if the JSON string is invalid with respect to PostBanUserUndoResponse
     */
    public static PostBanUserUndoResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostBanUserUndoResponse.class);
    }

    /**
     * Convert an instance of PostBanUserUndoResponse to an JSON string
     *
     * @return JSON string
     */
