...
public class FlagCommentResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("statusCode", "status", "code", "reason", "wasUnapproved"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FlagCommentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FlagCommentResponse is not found in the empty JSON string", FlagCommentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FlagCommentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FlagCommentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
