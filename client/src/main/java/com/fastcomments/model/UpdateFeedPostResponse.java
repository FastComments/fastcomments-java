...
public class UpdateFeedPostResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateFeedPostResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateFeedPostResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateFeedPostResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateFeedPostResponse>() {
                @Override
                public void write(JsonWriter out, UpdateFeedPostResponse value) throws IOException {
                ...
                @Override
                public UpdateFeedPostResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateFeedPostResponse ret = new UpdateFeedPostResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateFeedPostResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateFeedPostResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateFeedPostResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateFeedPostResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateFeedPostResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateFeedPostResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateFeedPostResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateFeedPostResponse
     */
    public static UpdateFeedPostResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateFeedPostResponse.class);
    }

    /**
     * Convert an instance of UpdateFeedPostResponse to an JSON string
     *
     * @return JSON string
     */
