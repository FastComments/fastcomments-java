...
public class DeleteQuestionConfigResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteQuestionConfigResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteQuestionConfigResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteQuestionConfigResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteQuestionConfigResponse>() {
                @Override
                public void write(JsonWriter out, DeleteQuestionConfigResponse value) throws IOException {
                ...
                @Override
                public DeleteQuestionConfigResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteQuestionConfigResponse ret = new DeleteQuestionConfigResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteQuestionConfigResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteQuestionConfigResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteQuestionConfigResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteQuestionConfigResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteQuestionConfigResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteQuestionConfigResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteQuestionConfigResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteQuestionConfigResponse
     */
    public static DeleteQuestionConfigResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteQuestionConfigResponse.class);
    }

    /**
     * Convert an instance of DeleteQuestionConfigResponse to an JSON string
     *
     * @return JSON string
     */
