...
public class CreateAPIUserSubscriptionData {
  ...
  public CreateAPIUserSubscriptionData url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public CreateAPIUserSubscriptionData urlId(@javax.annotation.Nonnull String urlId) {
    this.urlId = urlId;
    return this;
  }
  ...
  public CreateAPIUserSubscriptionData anonUserId(@javax.annotation.Nullable String anonUserId) {
  ...
  public CreateAPIUserSubscriptionData userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
   ...
   * @return the CreateAPIUserSubscriptionData instance itself
   */
  public CreateAPIUserSubscriptionData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.notificationFrequency, createAPIUserSubscriptionData.notificationFrequency) &&
        ...
        Objects.equals(this.userId, createAPIUserSubscriptionData.userId)&&
        Objects.equals(this.additionalProperties, createAPIUserSubscriptionData.additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("notificationFrequency", "pageTitle", "url", "urlId", "anonUserId", "userId"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("urlId"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAPIUserSubscriptionData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAPIUserSubscriptionData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAPIUserSubscriptionData is not found in the empty JSON string", CreateAPIUserSubscriptionData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAPIUserSubscriptionData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAPIUserSubscriptionData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAPIUserSubscriptionData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAPIUserSubscriptionData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAPIUserSubscriptionData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAPIUserSubscriptionData>() {
           @Override
           public void write(JsonWriter out, CreateAPIUserSubscriptionData value) throws IOException {
           ...
           @Override
           public CreateAPIUserSubscriptionData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateAPIUserSubscriptionData instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateAPIUserSubscriptionData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAPIUserSubscriptionData
   * @throws IOException if the JSON string is invalid with respect to CreateAPIUserSubscriptionData
   */
  public static CreateAPIUserSubscriptionData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAPIUserSubscriptionData.class);
  }

  /**
   * Convert an instance of CreateAPIUserSubscriptionData to an JSON string
   *
   * @return JSON string
   */
