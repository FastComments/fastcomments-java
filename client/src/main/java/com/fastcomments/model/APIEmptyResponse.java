...
import com.fastcomments.model.APIErrorInternal;
...
public class APIEmptyResponse extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<APIErrorInternal> adapterAPIErrorInternal = gson.getDelegateAdapter(this, TypeToken.get(APIErrorInternal.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<APIEmptyResponse>() {
                ...
                public void write(JsonWriter out, APIEmptyResponse value) throws IOException {
                    ...
                    // check if the actual instance is of the type `APIErrorInternal`
                    if (value.getActualInstance() instanceof APIErrorInternal) {
                        JsonElement element = adapterAPIErrorInternal.toJsonTree((APIErrorInternal)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: APIEmptyResponseAnyOf, APIErrorInternal");
                }
                ...
                public APIEmptyResponse read(JsonReader in) throws IOException {
                    ...
                    // deserialize APIErrorInternal
                    try {
                        // validate the JSON object to see if any exception is thrown
                        APIErrorInternal.validateJsonElement(jsonElement);
                        actualAdapter = adapterAPIErrorInternal;
                        APIEmptyResponse ret = new APIEmptyResponse();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for APIErrorInternal failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'APIErrorInternal'", e);
                    }
    ...
    static {
        ...
        schemas.put("APIErrorInternal", APIErrorInternal.class);
    }
     ...
     * APIEmptyResponseAnyOf, APIErrorInternal
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof APIErrorInternal) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be APIEmptyResponseAnyOf, APIErrorInternal");
    }
     ...
     * APIEmptyResponseAnyOf, APIErrorInternal
     *
     * @return The actual instance (APIEmptyResponseAnyOf, APIErrorInternal)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `APIErrorInternal`. If the actual instance is not `APIErrorInternal`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `APIErrorInternal`
     * @throws ClassCastException if the instance is not `APIErrorInternal`
     */
    public APIErrorInternal getAPIErrorInternal() throws ClassCastException {
        return (APIErrorInternal)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with APIErrorInternal
        try {
            APIErrorInternal.validateJsonElement(jsonElement);
            return;
        } catch (Exception e) {
        ...
        throw new IOException(String.format("The JSON string is invalid for APIEmptyResponse with anyOf schemas: APIEmptyResponseAnyOf, APIErrorInternal. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
