...
public class APIEmptyResponse {
  ...
  public APIEmptyResponse status(@javax.annotation.Nonnull APIStatus status) {
    this.status = status;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIEmptyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in APIEmptyResponse is not found in the empty JSON string", APIEmptyResponse.openapiRequiredFields.toString()));
        }
      }
