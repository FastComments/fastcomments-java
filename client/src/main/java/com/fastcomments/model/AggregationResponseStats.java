...
public class AggregationResponseStats {
   ...
   * @return the AggregationResponseStats instance itself
   */
  public AggregationResponseStats putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timeMS, aggregationResponseStats.timeMS) &&
        ...
        Objects.equals(this.additionalProperties, aggregationResponseStats.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timeMS, scanned, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("timeMS", "scanned"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("timeMS", "scanned"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregationResponseStats.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AggregationResponseStats is not found in the empty JSON string", AggregationResponseStats.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AggregationResponseStats>() {
           ...
           public AggregationResponseStats read(JsonReader in) throws IOException {
             ...
             AggregationResponseStats instance = thisAdapter.fromJsonTree(jsonObj);
