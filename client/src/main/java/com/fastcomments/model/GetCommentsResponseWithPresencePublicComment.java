...
public class GetCommentsResponseWithPresencePublicComment {
   ...
   * @return the GetCommentsResponseWithPresencePublicComment instance itself
   */
  public GetCommentsResponseWithPresencePublicComment putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetCommentsResponseWithPresencePublicComment>() {
           ...
           public GetCommentsResponseWithPresencePublicComment read(JsonReader in) throws IOException {
             ...
             GetCommentsResponseWithPresencePublicComment instance = thisAdapter.fromJsonTree(jsonObj);
