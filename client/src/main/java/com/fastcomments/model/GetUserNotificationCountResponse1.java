...
public class GetUserNotificationCountResponse1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetUserNotificationCountResponse1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetUserNotificationCountResponse1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetUserNotificationCountResponse1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetUserNotificationCountResponse1>() {
                @Override
                public void write(JsonWriter out, GetUserNotificationCountResponse1 value) throws IOException {
                ...
                @Override
                public GetUserNotificationCountResponse1 read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        GetUserNotificationCountResponse1 ret = new GetUserNotificationCountResponse1();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetUserNotificationCountResponse1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetUserNotificationCountResponse1() {
        super("anyOf", Boolean.FALSE);
    }

    public GetUserNotificationCountResponse1(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetUserNotificationCountResponse1.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetUserNotificationCountResponse1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for GetUserNotificationCountResponse1 with anyOf schemas: APIError, GetUserNotificationCountResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GetUserNotificationCountResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetUserNotificationCountResponse1
     * @throws IOException if the JSON string is invalid with respect to GetUserNotificationCountResponse1
     */
    public static GetUserNotificationCountResponse1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetUserNotificationCountResponse1.class);
    }

    /**
     * Convert an instance of GetUserNotificationCountResponse1 to an JSON string
     *
     * @return JSON string
     */
