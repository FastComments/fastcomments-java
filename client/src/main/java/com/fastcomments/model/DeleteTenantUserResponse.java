...
public class DeleteTenantUserResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteTenantUserResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteTenantUserResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteTenantUserResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteTenantUserResponse>() {
                @Override
                public void write(JsonWriter out, DeleteTenantUserResponse value) throws IOException {
                ...
                @Override
                public DeleteTenantUserResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteTenantUserResponse ret = new DeleteTenantUserResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteTenantUserResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteTenantUserResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public DeleteTenantUserResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteTenantUserResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteTenantUserResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteTenantUserResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteTenantUserResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteTenantUserResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteTenantUserResponse
     */
    public static DeleteTenantUserResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteTenantUserResponse.class);
    }

    /**
     * Convert an instance of DeleteTenantUserResponse to an JSON string
     *
     * @return JSON string
     */
