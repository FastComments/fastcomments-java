...
public class ResetUserNotifications200Response extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ResetUserNotifications200Response>() {
                ...
                public void write(JsonWriter out, ResetUserNotifications200Response value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, ResetUserNotificationsResponse");
                }
     ...
     * PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, ResetUserNotificationsResponse
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, ResetUserNotificationsResponse");
    }
     ...
     * PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, ResetUserNotificationsResponse
     *
     * @return The actual instance (PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, ResetUserNotificationsResponse)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for ResetUserNotifications200Response with anyOf schemas: PickAPIErrorInternalExcludeKeyofAPIErrorInternalStatusCode, ResetUserNotificationsResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
