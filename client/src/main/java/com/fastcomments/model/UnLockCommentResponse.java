...
public class UnLockCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UnLockCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UnLockCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UnLockCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UnLockCommentResponse>() {
                @Override
                public void write(JsonWriter out, UnLockCommentResponse value) throws IOException {
                ...
                @Override
                public UnLockCommentResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UnLockCommentResponse ret = new UnLockCommentResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UnLockCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UnLockCommentResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UnLockCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UnLockCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UnLockCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UnLockCommentResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UnLockCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UnLockCommentResponse
     * @throws IOException if the JSON string is invalid with respect to UnLockCommentResponse
     */
    public static UnLockCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UnLockCommentResponse.class);
    }

    /**
     * Convert an instance of UnLockCommentResponse to an JSON string
     *
     * @return JSON string
     */
