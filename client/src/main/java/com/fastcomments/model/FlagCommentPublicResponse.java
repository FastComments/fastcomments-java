...
public class FlagCommentPublicResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(FlagCommentPublicResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FlagCommentPublicResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FlagCommentPublicResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<FlagCommentPublicResponse>() {
                @Override
                public void write(JsonWriter out, FlagCommentPublicResponse value) throws IOException {
                ...
                @Override
                public FlagCommentPublicResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        FlagCommentPublicResponse ret = new FlagCommentPublicResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for FlagCommentPublicResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public FlagCommentPublicResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public FlagCommentPublicResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return FlagCommentPublicResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to FlagCommentPublicResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for FlagCommentPublicResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of FlagCommentPublicResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of FlagCommentPublicResponse
     * @throws IOException if the JSON string is invalid with respect to FlagCommentPublicResponse
     */
    public static FlagCommentPublicResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, FlagCommentPublicResponse.class);
    }

    /**
     * Convert an instance of FlagCommentPublicResponse to an JSON string
     *
     * @return JSON string
     */
