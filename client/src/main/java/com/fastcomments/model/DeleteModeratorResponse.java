...
public class DeleteModeratorResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteModeratorResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteModeratorResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteModeratorResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteModeratorResponse>() {
                @Override
                public void write(JsonWriter out, DeleteModeratorResponse value) throws IOException {
                ...
                @Override
                public DeleteModeratorResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteModeratorResponse ret = new DeleteModeratorResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteModeratorResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteModeratorResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public DeleteModeratorResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteModeratorResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteModeratorResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteModeratorResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteModeratorResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteModeratorResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteModeratorResponse
     */
    public static DeleteModeratorResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteModeratorResponse.class);
    }

    /**
     * Convert an instance of DeleteModeratorResponse to an JSON string
     *
     * @return JSON string
     */
