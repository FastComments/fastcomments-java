...
public class ReplaceTenantPackageResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ReplaceTenantPackageResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ReplaceTenantPackageResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ReplaceTenantPackageResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ReplaceTenantPackageResponse>() {
                @Override
                public void write(JsonWriter out, ReplaceTenantPackageResponse value) throws IOException {
                ...
                @Override
                public ReplaceTenantPackageResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ReplaceTenantPackageResponse ret = new ReplaceTenantPackageResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ReplaceTenantPackageResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ReplaceTenantPackageResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ReplaceTenantPackageResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ReplaceTenantPackageResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ReplaceTenantPackageResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of ReplaceTenantPackageResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ReplaceTenantPackageResponse
     * @throws IOException if the JSON string is invalid with respect to ReplaceTenantPackageResponse
     */
    public static ReplaceTenantPackageResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ReplaceTenantPackageResponse.class);
    }

    /**
     * Convert an instance of ReplaceTenantPackageResponse to an JSON string
     *
     * @return JSON string
     */
