...
public class UpdateEmailTemplateResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateEmailTemplateResponse.class.getName());
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateEmailTemplateResponse>() {
                ...
                public UpdateEmailTemplateResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateEmailTemplateResponse ret = new UpdateEmailTemplateResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateEmailTemplateResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateEmailTemplateResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateEmailTemplateResponse.schemas;
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateEmailTemplateResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
