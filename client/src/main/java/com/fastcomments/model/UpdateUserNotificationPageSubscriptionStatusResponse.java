...
public class UpdateUserNotificationPageSubscriptionStatusResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateUserNotificationPageSubscriptionStatusResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateUserNotificationPageSubscriptionStatusResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateUserNotificationPageSubscriptionStatusResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateUserNotificationPageSubscriptionStatusResponse>() {
                @Override
                public void write(JsonWriter out, UpdateUserNotificationPageSubscriptionStatusResponse value) throws IOException {
                ...
                @Override
                public UpdateUserNotificationPageSubscriptionStatusResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateUserNotificationPageSubscriptionStatusResponse ret = new UpdateUserNotificationPageSubscriptionStatusResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateUserNotificationPageSubscriptionStatusResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateUserNotificationPageSubscriptionStatusResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UpdateUserNotificationPageSubscriptionStatusResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateUserNotificationPageSubscriptionStatusResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateUserNotificationPageSubscriptionStatusResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateUserNotificationPageSubscriptionStatusResponse with anyOf schemas: APIError, IgnoredResponse, UserNotificationWriteResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateUserNotificationPageSubscriptionStatusResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateUserNotificationPageSubscriptionStatusResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateUserNotificationPageSubscriptionStatusResponse
     */
    public static UpdateUserNotificationPageSubscriptionStatusResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateUserNotificationPageSubscriptionStatusResponse.class);
    }

    /**
     * Convert an instance of UpdateUserNotificationPageSubscriptionStatusResponse to an JSON string
     *
     * @return JSON string
     */
