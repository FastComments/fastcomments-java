...
public class DeleteEmailTemplateRenderErrorResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(DeleteEmailTemplateRenderErrorResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteEmailTemplateRenderErrorResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteEmailTemplateRenderErrorResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteEmailTemplateRenderErrorResponse>() {
                @Override
                public void write(JsonWriter out, DeleteEmailTemplateRenderErrorResponse value) throws IOException {
                ...
                @Override
                public DeleteEmailTemplateRenderErrorResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        DeleteEmailTemplateRenderErrorResponse ret = new DeleteEmailTemplateRenderErrorResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteEmailTemplateRenderErrorResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public DeleteEmailTemplateRenderErrorResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return DeleteEmailTemplateRenderErrorResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DeleteEmailTemplateRenderErrorResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteEmailTemplateRenderErrorResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of DeleteEmailTemplateRenderErrorResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DeleteEmailTemplateRenderErrorResponse
     * @throws IOException if the JSON string is invalid with respect to DeleteEmailTemplateRenderErrorResponse
     */
    public static DeleteEmailTemplateRenderErrorResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DeleteEmailTemplateRenderErrorResponse.class);
    }

    /**
     * Convert an instance of DeleteEmailTemplateRenderErrorResponse to an JSON string
     *
     * @return JSON string
     */
