...
public class AggregationValue {
   ...
   * @return the AggregationValue instance itself
   */
  public AggregationValue putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groups, aggregationValue.groups) &&
        ...
        Objects.equals(this.additionalProperties, aggregationValue.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groups, stringValue, numericValue, distinctCount, distinctCounts, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("groups", "stringValue", "numericValue", "distinctCount", "distinctCounts"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AggregationValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AggregationValue is not found in the empty JSON string", AggregationValue.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AggregationValue>() {
           ...
           public AggregationValue read(JsonReader in) throws IOException {
             ...
             AggregationValue instance = thisAdapter.fromJsonTree(jsonObj);
