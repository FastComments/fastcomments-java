...
public class CreateAPISSOUserData {
  ...
  public CreateAPISSOUserData() {
  }

  public CreateAPISSOUserData groupIds(@javax.annotation.Nullable List<String> groupIds) {
    this.groupIds = groupIds;
    return this;
  }

  public CreateAPISSOUserData addGroupIdsItem(String groupIdsItem) {
  ...
  public CreateAPISSOUserData hasBlockedUsers(@javax.annotation.Nullable Boolean hasBlockedUsers) {
  ...
  public CreateAPISSOUserData isProfileDMDisabled(@javax.annotation.Nullable Boolean isProfileDMDisabled) {
  ...
  public CreateAPISSOUserData isProfileCommentsPrivate(@javax.annotation.Nullable Boolean isProfileCommentsPrivate) {
  ...
  public CreateAPISSOUserData isProfileActivityPrivate(@javax.annotation.Nullable Boolean isProfileActivityPrivate) {
  ...
  public CreateAPISSOUserData isCommentModeratorAdmin(@javax.annotation.Nullable Boolean isCommentModeratorAdmin) {
  ...
  public CreateAPISSOUserData isAdminAdmin(@javax.annotation.Nullable Boolean isAdminAdmin) {
  ...
  public CreateAPISSOUserData isAccountOwner(@javax.annotation.Nullable Boolean isAccountOwner) {
  ...
  public CreateAPISSOUserData displayName(@javax.annotation.Nullable String displayName) {
  ...
  public CreateAPISSOUserData displayLabel(@javax.annotation.Nullable String displayLabel) {
  ...
  public CreateAPISSOUserData optedInSubscriptionNotifications(@javax.annotation.Nullable Boolean optedInSubscriptionNotifications) {
  ...
  public CreateAPISSOUserData optedInNotifications(@javax.annotation.Nullable Boolean optedInNotifications) {
  ...
  public CreateAPISSOUserData avatarSrc(@javax.annotation.Nullable String avatarSrc) {
  ...
  public CreateAPISSOUserData loginCount(@javax.annotation.Nullable Integer loginCount) {
  ...
  public CreateAPISSOUserData createdFromUrlId(@javax.annotation.Nullable String createdFromUrlId) {
  ...
  public CreateAPISSOUserData signUpDate(@javax.annotation.Nullable Long signUpDate) {
  ...
  public CreateAPISSOUserData email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public CreateAPISSOUserData websiteUrl(@javax.annotation.Nullable String websiteUrl) {
  ...
  public CreateAPISSOUserData username(@javax.annotation.Nonnull String username) {
  ...
  public CreateAPISSOUserData id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
   ...
   * @return the CreateAPISSOUserData instance itself
   */
  public CreateAPISSOUserData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAPISSOUserData createAPISSOUserData = (CreateAPISSOUserData) o;
    return Objects.equals(this.groupIds, createAPISSOUserData.groupIds) &&
        Objects.equals(this.hasBlockedUsers, createAPISSOUserData.hasBlockedUsers) &&
        Objects.equals(this.isProfileDMDisabled, createAPISSOUserData.isProfileDMDisabled) &&
        Objects.equals(this.isProfileCommentsPrivate, createAPISSOUserData.isProfileCommentsPrivate) &&
        Objects.equals(this.isProfileActivityPrivate, createAPISSOUserData.isProfileActivityPrivate) &&
        Objects.equals(this.isCommentModeratorAdmin, createAPISSOUserData.isCommentModeratorAdmin) &&
        Objects.equals(this.isAdminAdmin, createAPISSOUserData.isAdminAdmin) &&
        Objects.equals(this.isAccountOwner, createAPISSOUserData.isAccountOwner) &&
        Objects.equals(this.displayName, createAPISSOUserData.displayName) &&
        Objects.equals(this.displayLabel, createAPISSOUserData.displayLabel) &&
        Objects.equals(this.optedInSubscriptionNotifications, createAPISSOUserData.optedInSubscriptionNotifications) &&
        Objects.equals(this.optedInNotifications, createAPISSOUserData.optedInNotifications) &&
        Objects.equals(this.avatarSrc, createAPISSOUserData.avatarSrc) &&
        Objects.equals(this.loginCount, createAPISSOUserData.loginCount) &&
        Objects.equals(this.createdFromUrlId, createAPISSOUserData.createdFromUrlId) &&
        Objects.equals(this.signUpDate, createAPISSOUserData.signUpDate) &&
        Objects.equals(this.email, createAPISSOUserData.email) &&
        Objects.equals(this.websiteUrl, createAPISSOUserData.websiteUrl) &&
        Objects.equals(this.username, createAPISSOUserData.username) &&
        Objects.equals(this.id, createAPISSOUserData.id)&&
        Objects.equals(this.additionalProperties, createAPISSOUserData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAPISSOUserData {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("groupIds", "hasBlockedUsers", "isProfileDMDisabled", "isProfileCommentsPrivate", "isProfileActivityPrivate", "isCommentModeratorAdmin", "isAdminAdmin", "isAccountOwner", "displayName", "displayLabel", "optedInSubscriptionNotifications", "optedInNotifications", "avatarSrc", "loginCount", "createdFromUrlId", "signUpDate", "email", "websiteUrl", "username", "id"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("email", "username", "id"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAPISSOUserData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAPISSOUserData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAPISSOUserData is not found in the empty JSON string", CreateAPISSOUserData.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAPISSOUserData.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAPISSOUserData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAPISSOUserData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAPISSOUserData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAPISSOUserData.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAPISSOUserData>() {
           @Override
           public void write(JsonWriter out, CreateAPISSOUserData value) throws IOException {
           ...
           @Override
           public CreateAPISSOUserData read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateAPISSOUserData instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of CreateAPISSOUserData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAPISSOUserData
   * @throws IOException if the JSON string is invalid with respect to CreateAPISSOUserData
   */
  public static CreateAPISSOUserData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAPISSOUserData.class);
  }

  /**
   * Convert an instance of CreateAPISSOUserData to an JSON string
   *
   * @return JSON string
   */
