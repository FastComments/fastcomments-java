...
public class SendInviteResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SendInviteResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SendInviteResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SendInviteResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SendInviteResponse>() {
                @Override
                public void write(JsonWriter out, SendInviteResponse value) throws IOException {
                ...
                @Override
                public SendInviteResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        SendInviteResponse ret = new SendInviteResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for SendInviteResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SendInviteResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return SendInviteResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to SendInviteResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for SendInviteResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of SendInviteResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SendInviteResponse
     * @throws IOException if the JSON string is invalid with respect to SendInviteResponse
     */
    public static SendInviteResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SendInviteResponse.class);
    }

    /**
     * Convert an instance of SendInviteResponse to an JSON string
     *
     * @return JSON string
     */
