...
public class GetEventLogResponse1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetEventLogResponse1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetEventLogResponse1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetEventLogResponse1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetEventLogResponse1>() {
                @Override
                public void write(JsonWriter out, GetEventLogResponse1 value) throws IOException {
                ...
                @Override
                public GetEventLogResponse1 read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        GetEventLogResponse1 ret = new GetEventLogResponse1();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetEventLogResponse1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetEventLogResponse1() {
        super("anyOf", Boolean.FALSE);
    }

    public GetEventLogResponse1(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetEventLogResponse1.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetEventLogResponse1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for GetEventLogResponse1 with anyOf schemas: APIError, GetEventLogResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GetEventLogResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetEventLogResponse1
     * @throws IOException if the JSON string is invalid with respect to GetEventLogResponse1
     */
    public static GetEventLogResponse1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetEventLogResponse1.class);
    }

    /**
     * Convert an instance of GetEventLogResponse1 to an JSON string
     *
     * @return JSON string
     */
