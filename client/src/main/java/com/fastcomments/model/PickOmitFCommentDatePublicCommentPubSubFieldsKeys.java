...
public class PickOmitFCommentDatePublicCommentPubSubFieldsKeys {
   ...
   * @return the PickOmitFCommentDatePublicCommentPubSubFieldsKeys instance itself
   */
  public PickOmitFCommentDatePublicCommentPubSubFieldsKeys putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, pickOmitFCommentDatePublicCommentPubSubFieldsKeys.date) &&
        Objects.equals(this.id, pickOmitFCommentDatePublicCommentPubSubFieldsKeys.id) &&
        ...
        Objects.equals(this.additionalProperties, pickOmitFCommentDatePublicCommentPubSubFieldsKeys.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, id, tenantId, urlId, url, pageTitle, userId, anonUserId, commenterName, commenterLink, comment, commentHTML, parentId, votes, votesUp, votesDown, expireAt, verified, reviewed, avatarSrc, isSpam, hasImages, hasLinks, hasCode, approved, locale, isDeleted, isDeletedUser, isBannedUser, isByAdmin, isByModerator, isPinned, isLocked, flagCount, rating, displayLabel, badges, domain, feedbackIds, groupIds, viewCount, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PickOmitFCommentDatePublicCommentPubSubFieldsKeys>() {
           ...
           public PickOmitFCommentDatePublicCommentPubSubFieldsKeys read(JsonReader in) throws IOException {
             ...
             PickOmitFCommentDatePublicCommentPubSubFieldsKeys instance = thisAdapter.fromJsonTree(jsonObj);
