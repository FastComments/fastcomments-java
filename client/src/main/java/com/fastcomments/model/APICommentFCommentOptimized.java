...
import com.fastcomments.model.PickFCommentExcludeKeyofFCommentLogsOrTenantIdOrCommentOrHasLinksOrUrlId;
...
public class APICommentFCommentOptimized {
  ...
  @javax.annotation.Nullable
  private List<PickFCommentExcludeKeyofFCommentLogsOrTenantIdOrCommentOrHasLinksOrUrlId> children = new ArrayList<>();
  ...
  public APICommentFCommentOptimized() {
  }

  public APICommentFCommentOptimized id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public APICommentFCommentOptimized urlIdRaw(@javax.annotation.Nullable String urlIdRaw) {
  ...
  public APICommentFCommentOptimized url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public APICommentFCommentOptimized pageTitle(@javax.annotation.Nullable String pageTitle) {
  ...
  public APICommentFCommentOptimized userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public APICommentFCommentOptimized anonUserId(@javax.annotation.Nullable String anonUserId) {
  ...
  public APICommentFCommentOptimized commenterEmail(@javax.annotation.Nullable String commenterEmail) {
  ...
  public APICommentFCommentOptimized commenterName(@javax.annotation.Nonnull String commenterName) {
  ...
  public APICommentFCommentOptimized commenterLink(@javax.annotation.Nullable String commenterLink) {
  ...
  public APICommentFCommentOptimized commentHTML(@javax.annotation.Nonnull String commentHTML) {
  ...
  public APICommentFCommentOptimized parentId(@javax.annotation.Nullable String parentId) {
  ...
  public APICommentFCommentOptimized date(@javax.annotation.Nonnull OffsetDateTime date) {
    this.date = date;
    return this;
  }
  ...
  public APICommentFCommentOptimized localDateString(@javax.annotation.Nullable String localDateString) {
  ...
  public APICommentFCommentOptimized localDateHours(@javax.annotation.Nullable Double localDateHours) {
  ...
  public APICommentFCommentOptimized votes(@javax.annotation.Nonnull Double votes) {
    this.votes = votes;
    return this;
  }
  ...
  public APICommentFCommentOptimized votesUp(@javax.annotation.Nonnull Double votesUp) {
  ...
  public APICommentFCommentOptimized votesDown(@javax.annotation.Nonnull Double votesDown) {
  ...
  public APICommentFCommentOptimized expireAt(@javax.annotation.Nullable OffsetDateTime expireAt) {
  ...
  public APICommentFCommentOptimized verified(@javax.annotation.Nonnull Boolean verified) {
  ...
  public APICommentFCommentOptimized verifiedDate(@javax.annotation.Nullable OffsetDateTime verifiedDate) {
  ...
  public APICommentFCommentOptimized verificationId(@javax.annotation.Nullable String verificationId) {
  ...
  public APICommentFCommentOptimized notificationSentForParent(@javax.annotation.Nullable Boolean notificationSentForParent) {
  ...
  public APICommentFCommentOptimized notificationSentForParentTenant(@javax.annotation.Nullable Boolean notificationSentForParentTenant) {
  ...
  public APICommentFCommentOptimized reviewed(@javax.annotation.Nullable Boolean reviewed) {
  ...
  public APICommentFCommentOptimized imported(@javax.annotation.Nullable Boolean imported) {
  ...
  public APICommentFCommentOptimized externalId(@javax.annotation.Nullable String externalId) {
  ...
  public APICommentFCommentOptimized externalParentId(@javax.annotation.Nullable String externalParentId) {
  ...
  public APICommentFCommentOptimized avatarSrc(@javax.annotation.Nullable String avatarSrc) {
  ...
  public APICommentFCommentOptimized isSpam(@javax.annotation.Nullable Boolean isSpam) {
    this.isSpam = isSpam;
    return this;
  }
  ...
  public APICommentFCommentOptimized aiDeterminedSpam(@javax.annotation.Nullable Boolean aiDeterminedSpam) {
  ...
  public APICommentFCommentOptimized hasImages(@javax.annotation.Nullable Boolean hasImages) {
  ...
  public APICommentFCommentOptimized pageNumber(@javax.annotation.Nullable Double pageNumber) {
  ...
  public APICommentFCommentOptimized pageNumberOF(@javax.annotation.Nullable Double pageNumberOF) {
  ...
  public APICommentFCommentOptimized pageNumberNF(@javax.annotation.Nullable Double pageNumberNF) {
  ...
  public APICommentFCommentOptimized hasCode(@javax.annotation.Nullable Boolean hasCode) {
  ...
  public APICommentFCommentOptimized approved(@javax.annotation.Nonnull Boolean approved) {
  ...
  public APICommentFCommentOptimized locale(@javax.annotation.Nonnull String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public APICommentFCommentOptimized isDeleted(@javax.annotation.Nullable Boolean isDeleted) {
  ...
  public APICommentFCommentOptimized isDeletedUser(@javax.annotation.Nullable Boolean isDeletedUser) {
  ...
  public APICommentFCommentOptimized isBannedUser(@javax.annotation.Nullable Boolean isBannedUser) {
  ...
  public APICommentFCommentOptimized isByAdmin(@javax.annotation.Nullable Boolean isByAdmin) {
  ...
  public APICommentFCommentOptimized isByModerator(@javax.annotation.Nullable Boolean isByModerator) {
  ...
  public APICommentFCommentOptimized isPinned(@javax.annotation.Nullable Boolean isPinned) {
  ...
  public APICommentFCommentOptimized isLocked(@javax.annotation.Nullable Boolean isLocked) {
  ...
  public APICommentFCommentOptimized flagCount(@javax.annotation.Nullable Double flagCount) {
  ...
  public APICommentFCommentOptimized rating(@javax.annotation.Nullable Double rating) {
    this.rating = rating;
    return this;
  }
  ...
  public APICommentFCommentOptimized displayLabel(@javax.annotation.Nullable String displayLabel) {
  ...
  public APICommentFCommentOptimized fromProductId(@javax.annotation.Nullable Double fromProductId) {
  ...
  public APICommentFCommentOptimized meta(@javax.annotation.Nullable PickFCommentExcludeKeyofFCommentLogsOrTenantIdOrCommentOrHasLinksOrUrlIdMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public APICommentFCommentOptimized ipHash(@javax.annotation.Nullable String ipHash) {
    this.ipHash = ipHash;
    return this;
  }
  ...
  public APICommentFCommentOptimized mentions(@javax.annotation.Nullable List<CommentUserMentionInfo> mentions) {
    this.mentions = mentions;
    return this;
  }

  public APICommentFCommentOptimized addMentionsItem(CommentUserMentionInfo mentionsItem) {
  ...
  public APICommentFCommentOptimized hashTags(@javax.annotation.Nullable List<CommentUserHashTagInfo> hashTags) {
    this.hashTags = hashTags;
    return this;
  }

  public APICommentFCommentOptimized addHashTagsItem(CommentUserHashTagInfo hashTagsItem) {
  ...
  public APICommentFCommentOptimized badges(@javax.annotation.Nullable List<CommentUserBadgeInfo> badges) {
    this.badges = badges;
    return this;
  }

  public APICommentFCommentOptimized addBadgesItem(CommentUserBadgeInfo badgesItem) {
    if (this.badges == null) {
  ...
  public APICommentFCommentOptimized domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public APICommentFCommentOptimized veteranBadgeProcessed(@javax.annotation.Nullable String veteranBadgeProcessed) {
  ...
  public APICommentFCommentOptimized moderationGroupIds(@javax.annotation.Nullable List<String> moderationGroupIds) {
    this.moderationGroupIds = moderationGroupIds;
    return this;
  }

  public APICommentFCommentOptimized addModerationGroupIdsItem(String moderationGroupIdsItem) {
  ...
  public APICommentFCommentOptimized didProcessBadges(@javax.annotation.Nullable Boolean didProcessBadges) {
  ...
  public APICommentFCommentOptimized fromOfflineRestore(@javax.annotation.Nullable Boolean fromOfflineRestore) {
  ...
  public APICommentFCommentOptimized autoplayJobId(@javax.annotation.Nullable String autoplayJobId) {
  ...
  public APICommentFCommentOptimized autoplayDelayMS(@javax.annotation.Nullable Double autoplayDelayMS) {
  ...
  public APICommentFCommentOptimized feedbackIds(@javax.annotation.Nullable List<String> feedbackIds) {
    this.feedbackIds = feedbackIds;
    return this;
  }

  public APICommentFCommentOptimized addFeedbackIdsItem(String feedbackIdsItem) {
  ...
  public APICommentFCommentOptimized groupIds(@javax.annotation.Nullable List<String> groupIds) {
    this.groupIds = groupIds;
    return this;
  }

  public APICommentFCommentOptimized addGroupIdsItem(String groupIdsItem) {
  ...
  public APICommentFCommentOptimized viewCount(@javax.annotation.Nullable Double viewCount) {
  ...
  public APICommentFCommentOptimized isUnread(@javax.annotation.Nullable Boolean isUnread) {
  ...
  public APICommentFCommentOptimized myVoteId(@javax.annotation.Nullable String myVoteId) {
  ...
  public APICommentFCommentOptimized isVotedDown(@javax.annotation.Nullable Boolean isVotedDown) {
  ...
  public APICommentFCommentOptimized isVotedUp(@javax.annotation.Nullable Boolean isVotedUp) {
  ...
  public APICommentFCommentOptimized hasChildren(@javax.annotation.Nullable Boolean hasChildren) {
  ...
  public APICommentFCommentOptimized children(@javax.annotation.Nullable List<PickFCommentExcludeKeyofFCommentLogsOrTenantIdOrCommentOrHasLinksOrUrlId> children) {
    this.children = children;
    return this;
  }

  public APICommentFCommentOptimized addChildrenItem(PickFCommentExcludeKeyofFCommentLogsOrTenantIdOrCommentOrHasLinksOrUrlId childrenItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<PickFCommentExcludeKeyofFCommentLogsOrTenantIdOrCommentOrHasLinksOrUrlId> getChildren() {
    return children;
  }

  public void setChildren(@javax.annotation.Nullable List<PickFCommentExcludeKeyofFCommentLogsOrTenantIdOrCommentOrHasLinksOrUrlId> children) {
    this.children = children;
  }


  public APICommentFCommentOptimized isFlagged(@javax.annotation.Nullable Boolean isFlagged) {
  ...
  public APICommentFCommentOptimized isBlocked(@javax.annotation.Nullable Boolean isBlocked) {
  ...
  public boolean equals(Object o) {
    ...
    APICommentFCommentOptimized apICommentFCommentOptimized = (APICommentFCommentOptimized) o;
    return Objects.equals(this.id, apICommentFCommentOptimized.id) &&
        Objects.equals(this.urlIdRaw, apICommentFCommentOptimized.urlIdRaw) &&
        Objects.equals(this.url, apICommentFCommentOptimized.url) &&
        Objects.equals(this.pageTitle, apICommentFCommentOptimized.pageTitle) &&
        Objects.equals(this.userId, apICommentFCommentOptimized.userId) &&
        Objects.equals(this.anonUserId, apICommentFCommentOptimized.anonUserId) &&
        Objects.equals(this.commenterEmail, apICommentFCommentOptimized.commenterEmail) &&
        Objects.equals(this.commenterName, apICommentFCommentOptimized.commenterName) &&
        Objects.equals(this.commenterLink, apICommentFCommentOptimized.commenterLink) &&
        Objects.equals(this.commentHTML, apICommentFCommentOptimized.commentHTML) &&
        Objects.equals(this.parentId, apICommentFCommentOptimized.parentId) &&
        Objects.equals(this.date, apICommentFCommentOptimized.date) &&
        Objects.equals(this.localDateString, apICommentFCommentOptimized.localDateString) &&
        Objects.equals(this.localDateHours, apICommentFCommentOptimized.localDateHours) &&
        Objects.equals(this.votes, apICommentFCommentOptimized.votes) &&
        Objects.equals(this.votesUp, apICommentFCommentOptimized.votesUp) &&
        Objects.equals(this.votesDown, apICommentFCommentOptimized.votesDown) &&
        Objects.equals(this.expireAt, apICommentFCommentOptimized.expireAt) &&
        Objects.equals(this.verified, apICommentFCommentOptimized.verified) &&
        Objects.equals(this.verifiedDate, apICommentFCommentOptimized.verifiedDate) &&
        Objects.equals(this.verificationId, apICommentFCommentOptimized.verificationId) &&
        Objects.equals(this.notificationSentForParent, apICommentFCommentOptimized.notificationSentForParent) &&
        Objects.equals(this.notificationSentForParentTenant, apICommentFCommentOptimized.notificationSentForParentTenant) &&
        Objects.equals(this.reviewed, apICommentFCommentOptimized.reviewed) &&
        Objects.equals(this.imported, apICommentFCommentOptimized.imported) &&
        Objects.equals(this.externalId, apICommentFCommentOptimized.externalId) &&
        Objects.equals(this.externalParentId, apICommentFCommentOptimized.externalParentId) &&
        Objects.equals(this.avatarSrc, apICommentFCommentOptimized.avatarSrc) &&
        Objects.equals(this.isSpam, apICommentFCommentOptimized.isSpam) &&
        Objects.equals(this.aiDeterminedSpam, apICommentFCommentOptimized.aiDeterminedSpam) &&
        Objects.equals(this.hasImages, apICommentFCommentOptimized.hasImages) &&
        Objects.equals(this.pageNumber, apICommentFCommentOptimized.pageNumber) &&
        Objects.equals(this.pageNumberOF, apICommentFCommentOptimized.pageNumberOF) &&
        Objects.equals(this.pageNumberNF, apICommentFCommentOptimized.pageNumberNF) &&
        Objects.equals(this.hasCode, apICommentFCommentOptimized.hasCode) &&
        Objects.equals(this.approved, apICommentFCommentOptimized.approved) &&
        Objects.equals(this.locale, apICommentFCommentOptimized.locale) &&
        Objects.equals(this.isDeleted, apICommentFCommentOptimized.isDeleted) &&
        Objects.equals(this.isDeletedUser, apICommentFCommentOptimized.isDeletedUser) &&
        Objects.equals(this.isBannedUser, apICommentFCommentOptimized.isBannedUser) &&
        Objects.equals(this.isByAdmin, apICommentFCommentOptimized.isByAdmin) &&
        Objects.equals(this.isByModerator, apICommentFCommentOptimized.isByModerator) &&
        Objects.equals(this.isPinned, apICommentFCommentOptimized.isPinned) &&
        Objects.equals(this.isLocked, apICommentFCommentOptimized.isLocked) &&
        Objects.equals(this.flagCount, apICommentFCommentOptimized.flagCount) &&
        Objects.equals(this.rating, apICommentFCommentOptimized.rating) &&
        Objects.equals(this.displayLabel, apICommentFCommentOptimized.displayLabel) &&
        Objects.equals(this.fromProductId, apICommentFCommentOptimized.fromProductId) &&
        Objects.equals(this.meta, apICommentFCommentOptimized.meta) &&
        Objects.equals(this.ipHash, apICommentFCommentOptimized.ipHash) &&
        Objects.equals(this.mentions, apICommentFCommentOptimized.mentions) &&
        Objects.equals(this.hashTags, apICommentFCommentOptimized.hashTags) &&
        Objects.equals(this.badges, apICommentFCommentOptimized.badges) &&
        Objects.equals(this.domain, apICommentFCommentOptimized.domain) &&
        Objects.equals(this.veteranBadgeProcessed, apICommentFCommentOptimized.veteranBadgeProcessed) &&
        Objects.equals(this.moderationGroupIds, apICommentFCommentOptimized.moderationGroupIds) &&
        Objects.equals(this.didProcessBadges, apICommentFCommentOptimized.didProcessBadges) &&
        Objects.equals(this.fromOfflineRestore, apICommentFCommentOptimized.fromOfflineRestore) &&
        Objects.equals(this.autoplayJobId, apICommentFCommentOptimized.autoplayJobId) &&
        Objects.equals(this.autoplayDelayMS, apICommentFCommentOptimized.autoplayDelayMS) &&
        Objects.equals(this.feedbackIds, apICommentFCommentOptimized.feedbackIds) &&
        Objects.equals(this.groupIds, apICommentFCommentOptimized.groupIds) &&
        Objects.equals(this.viewCount, apICommentFCommentOptimized.viewCount) &&
        Objects.equals(this.isUnread, apICommentFCommentOptimized.isUnread) &&
        Objects.equals(this.myVoteId, apICommentFCommentOptimized.myVoteId) &&
        Objects.equals(this.isVotedDown, apICommentFCommentOptimized.isVotedDown) &&
        Objects.equals(this.isVotedUp, apICommentFCommentOptimized.isVotedUp) &&
        Objects.equals(this.hasChildren, apICommentFCommentOptimized.hasChildren) &&
        Objects.equals(this.children, apICommentFCommentOptimized.children) &&
        Objects.equals(this.isFlagged, apICommentFCommentOptimized.isFlagged) &&
        Objects.equals(this.isBlocked, apICommentFCommentOptimized.isBlocked);
  }
  ...
  public String toString() {
    ...
    sb.append("class APICommentFCommentOptimized {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to APICommentFCommentOptimized
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APICommentFCommentOptimized.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in APICommentFCommentOptimized is not found in the empty JSON string", APICommentFCommentOptimized.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!APICommentFCommentOptimized.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `APICommentFCommentOptimized` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : APICommentFCommentOptimized.openapiRequiredFields) {
      ...
      if (jsonObj.get("children") != null && !jsonObj.get("children").isJsonNull()) {
        ...
        if (jsonArraychildren != null) {
          ...
          for (int i = 0; i < jsonArraychildren.size(); i++) {
            PickFCommentExcludeKeyofFCommentLogsOrTenantIdOrCommentOrHasLinksOrUrlId.validateJsonElement(jsonArraychildren.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!APICommentFCommentOptimized.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'APICommentFCommentOptimized' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<APICommentFCommentOptimized> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(APICommentFCommentOptimized.class));

       return (TypeAdapter<T>) new TypeAdapter<APICommentFCommentOptimized>() {
           @Override
           public void write(JsonWriter out, APICommentFCommentOptimized value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public APICommentFCommentOptimized read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of APICommentFCommentOptimized given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of APICommentFCommentOptimized
   * @throws IOException if the JSON string is invalid with respect to APICommentFCommentOptimized
   */
  public static APICommentFCommentOptimized fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, APICommentFCommentOptimized.class);
  }

  /**
   * Convert an instance of APICommentFCommentOptimized to an JSON string
   *
   * @return JSON string
   */
