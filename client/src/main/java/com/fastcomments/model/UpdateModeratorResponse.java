...
public class UpdateModeratorResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateModeratorResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateModeratorResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateModeratorResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateModeratorResponse>() {
                @Override
                public void write(JsonWriter out, UpdateModeratorResponse value) throws IOException {
                ...
                @Override
                public UpdateModeratorResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateModeratorResponse ret = new UpdateModeratorResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateModeratorResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateModeratorResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UpdateModeratorResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateModeratorResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateModeratorResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateModeratorResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateModeratorResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateModeratorResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateModeratorResponse
     */
    public static UpdateModeratorResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateModeratorResponse.class);
    }

    /**
     * Convert an instance of UpdateModeratorResponse to an JSON string
     *
     * @return JSON string
     */
