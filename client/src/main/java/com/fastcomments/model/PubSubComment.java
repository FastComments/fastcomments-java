...
public class PubSubComment {
  ...
  public PubSubComment locale(@javax.annotation.Nullable String locale) {
    this.locale = locale;
    return this;
  }
   ...
   * @return the PubSubComment instance itself
   */
  public PubSubComment putAdditionalProperty(String key, Object value) {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("_id", "tenantId", "urlId", "commenterName", "commentHTML", "comment", "verified", "url", "approved", "locale", "date"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PubSubComment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PubSubComment is not found in the empty JSON string", PubSubComment.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PubSubComment>() {
           ...
           public PubSubComment read(JsonReader in) throws IOException {
             ...
             PubSubComment instance = thisAdapter.fromJsonTree(jsonObj);
