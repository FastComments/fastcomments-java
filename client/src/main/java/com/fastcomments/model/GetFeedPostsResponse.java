...
public class GetFeedPostsResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "feedPosts"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFeedPostsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetFeedPostsResponse is not found in the empty JSON string", GetFeedPostsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFeedPostsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetFeedPostsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
