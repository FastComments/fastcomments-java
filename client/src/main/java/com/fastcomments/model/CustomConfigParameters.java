...
public class CustomConfigParameters {
  ...
  public static final String SERIALIZED_NAME_IMAGE_CONTENT_PROFANITY_LEVEL = "imageContentProfanityLevel";
  @SerializedName(SERIALIZED_NAME_IMAGE_CONTENT_PROFANITY_LEVEL)
  @javax.annotation.Nullable
  private ImageContentProfanityLevel imageContentProfanityLevel;
  ...
  public static final String SERIALIZED_NAME_NO_NEW_ROOT_COMMENTS = "noNewRootComments";
  @SerializedName(SERIALIZED_NAME_NO_NEW_ROOT_COMMENTS)
  @javax.annotation.Nullable
  private Boolean noNewRootComments;
  ...
  @javax.annotation.Nullable
  private Boolean enableResizeHandle;
  ...
  public CustomConfigParameters imageContentProfanityLevel(@javax.annotation.Nullable ImageContentProfanityLevel imageContentProfanityLevel) {
    this.imageContentProfanityLevel = imageContentProfanityLevel;
    return this;
  }

  /**
   * Get imageContentProfanityLevel
   * @return imageContentProfanityLevel
   */
  @javax.annotation.Nullable
  public ImageContentProfanityLevel getImageContentProfanityLevel() {
    return imageContentProfanityLevel;
  }

  public void setImageContentProfanityLevel(@javax.annotation.Nullable ImageContentProfanityLevel imageContentProfanityLevel) {
    this.imageContentProfanityLevel = imageContentProfanityLevel;
  }
  ...
  public CustomConfigParameters noNewRootComments(@javax.annotation.Nullable Boolean noNewRootComments) {
    this.noNewRootComments = noNewRootComments;
    return this;
  }

  /**
   * Get noNewRootComments
   * @return noNewRootComments
   */
  @javax.annotation.Nullable
  public Boolean getNoNewRootComments() {
    return noNewRootComments;
  }

  public void setNoNewRootComments(@javax.annotation.Nullable Boolean noNewRootComments) {
    this.noNewRootComments = noNewRootComments;
  }
  ...
  public CustomConfigParameters enableResizeHandle(@javax.annotation.Nullable Boolean enableResizeHandle) {
    this.enableResizeHandle = enableResizeHandle;
    return this;
  }

  /**
   * Get enableResizeHandle
   * @return enableResizeHandle
   */
  @javax.annotation.Nullable
  public Boolean getEnableResizeHandle() {
    return enableResizeHandle;
  }

  public void setEnableResizeHandle(@javax.annotation.Nullable Boolean enableResizeHandle) {
    this.enableResizeHandle = enableResizeHandle;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.absoluteAndRelativeDates, customConfigParameters.absoluteAndRelativeDates) &&
        ...
        Objects.equals(this.imageContentProfanityLevel, customConfigParameters.imageContentProfanityLevel) &&
  ...
  public String toString() {
    ...
    sb.append("    imageContentProfanityLevel: ").append(toIndentedString(imageContentProfanityLevel)).append("\n");
