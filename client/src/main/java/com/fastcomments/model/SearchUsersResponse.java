...
public class SearchUsersResponse {
  ...
  public SearchUsersResponse status(@javax.annotation.Nonnull APIStatus status) {
    this.status = status;
    return this;
  }
  ...
  public SearchUsersResponse users(@javax.annotation.Nonnull List<UserSearchResult> users) {
    this.users = users;
    return this;
  }

  public SearchUsersResponse addUsersItem(UserSearchResult usersItem) {
    if (this.users == null) {
   ...
   * @return the SearchUsersResponse instance itself
   */
  public SearchUsersResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, searchUsersResponse.status) &&
        Objects.equals(this.users, searchUsersResponse.users)&&
        Objects.equals(this.additionalProperties, searchUsersResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, users, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "users"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("status", "users"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchUsersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SearchUsersResponse is not found in the empty JSON string", SearchUsersResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchUsersResponse.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchUsersResponse>() {
           ...
           public SearchUsersResponse read(JsonReader in) throws IOException {
             ...
             SearchUsersResponse instance = thisAdapter.fromJsonTree(jsonObj);
