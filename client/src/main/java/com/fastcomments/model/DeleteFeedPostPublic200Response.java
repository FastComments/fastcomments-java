...
public class DeleteFeedPostPublic200Response extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<DeleteFeedPostPublic200Response>() {
                ...
                public DeleteFeedPostPublic200Response read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for DeleteFeedPostPublic200ResponseAnyOf failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for DeleteFeedPostPublic200Response: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for DeleteFeedPostPublic200Response with anyOf schemas: APIError, DeleteFeedPostPublic200ResponseAnyOf. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
