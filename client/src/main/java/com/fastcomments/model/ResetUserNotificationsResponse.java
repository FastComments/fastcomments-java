...
public class ResetUserNotificationsResponse {
  ...
  public ResetUserNotificationsResponse status(@javax.annotation.Nonnull APIStatus status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "code"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResetUserNotificationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ResetUserNotificationsResponse is not found in the empty JSON string", ResetUserNotificationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResetUserNotificationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ResetUserNotificationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
