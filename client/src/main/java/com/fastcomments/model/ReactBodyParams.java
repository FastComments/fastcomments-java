...
public class ReactBodyParams {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("reactType"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReactBodyParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ReactBodyParams is not found in the empty JSON string", ReactBodyParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReactBodyParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ReactBodyParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
