...
public class PostSetCommentSpamStatusResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PostSetCommentSpamStatusResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PostSetCommentSpamStatusResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PostSetCommentSpamStatusResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PostSetCommentSpamStatusResponse>() {
                @Override
                public void write(JsonWriter out, PostSetCommentSpamStatusResponse value) throws IOException {
                ...
                @Override
                public PostSetCommentSpamStatusResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        PostSetCommentSpamStatusResponse ret = new PostSetCommentSpamStatusResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PostSetCommentSpamStatusResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PostSetCommentSpamStatusResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PostSetCommentSpamStatusResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PostSetCommentSpamStatusResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PostSetCommentSpamStatusResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PostSetCommentSpamStatusResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PostSetCommentSpamStatusResponse
     * @throws IOException if the JSON string is invalid with respect to PostSetCommentSpamStatusResponse
     */
    public static PostSetCommentSpamStatusResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PostSetCommentSpamStatusResponse.class);
    }

    /**
     * Convert an instance of PostSetCommentSpamStatusResponse to an JSON string
     *
     * @return JSON string
     */
