...
public class ResetUserNotificationsResponse1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ResetUserNotificationsResponse1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ResetUserNotificationsResponse1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ResetUserNotificationsResponse1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ResetUserNotificationsResponse1>() {
                @Override
                public void write(JsonWriter out, ResetUserNotificationsResponse1 value) throws IOException {
                ...
                @Override
                public ResetUserNotificationsResponse1 read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        ResetUserNotificationsResponse1 ret = new ResetUserNotificationsResponse1();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ResetUserNotificationsResponse1: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ResetUserNotificationsResponse1() {
        super("anyOf", Boolean.FALSE);
    }

    public ResetUserNotificationsResponse1(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ResetUserNotificationsResponse1.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ResetUserNotificationsResponse1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ResetUserNotificationsResponse1 with anyOf schemas: APIError, ResetUserNotificationsResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of ResetUserNotificationsResponse1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ResetUserNotificationsResponse1
     * @throws IOException if the JSON string is invalid with respect to ResetUserNotificationsResponse1
     */
    public static ResetUserNotificationsResponse1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ResetUserNotificationsResponse1.class);
    }

    /**
     * Convert an instance of ResetUserNotificationsResponse1 to an JSON string
     *
     * @return JSON string
     */
