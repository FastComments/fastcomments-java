...
public class UpdateTenantUserResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateTenantUserResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateTenantUserResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateTenantUserResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<UpdateTenantUserResponse>() {
                @Override
                public void write(JsonWriter out, UpdateTenantUserResponse value) throws IOException {
                ...
                @Override
                public UpdateTenantUserResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        UpdateTenantUserResponse ret = new UpdateTenantUserResponse();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateTenantUserResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public UpdateTenantUserResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public UpdateTenantUserResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return UpdateTenantUserResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateTenantUserResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for UpdateTenantUserResponse with anyOf schemas: APIEmptyResponse, APIError. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of UpdateTenantUserResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateTenantUserResponse
     * @throws IOException if the JSON string is invalid with respect to UpdateTenantUserResponse
     */
    public static UpdateTenantUserResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateTenantUserResponse.class);
    }

    /**
     * Convert an instance of UpdateTenantUserResponse to an JSON string
     *
     * @return JSON string
     */
