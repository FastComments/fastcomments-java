...
public class ChangeCommentPinStatusResponse {
  ...
  public ChangeCommentPinStatusResponse status(@javax.annotation.Nonnull APIStatus status) {
    this.status = status;
    return this;
  }
   ...
   * @return the ChangeCommentPinStatusResponse instance itself
   */
  public ChangeCommentPinStatusResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commentPositions, changeCommentPinStatusResponse.commentPositions) &&
        ...
        Objects.equals(this.additionalProperties, changeCommentPinStatusResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commentPositions, status, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("commentPositions", "status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("commentPositions", "status"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeCommentPinStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChangeCommentPinStatusResponse is not found in the empty JSON string", ChangeCommentPinStatusResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChangeCommentPinStatusResponse>() {
           ...
           public ChangeCommentPinStatusResponse read(JsonReader in) throws IOException {
             ...
             ChangeCommentPinStatusResponse instance = thisAdapter.fromJsonTree(jsonObj);
