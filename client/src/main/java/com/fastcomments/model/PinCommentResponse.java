...
public class PinCommentResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PinCommentResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PinCommentResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PinCommentResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<PinCommentResponse>() {
                @Override
                public void write(JsonWriter out, PinCommentResponse value) throws IOException {
                ...
                @Override
                public PinCommentResponse read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for PinCommentResponse: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public PinCommentResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public PinCommentResponse(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return PinCommentResponse.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to PinCommentResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for PinCommentResponse with anyOf schemas: APIError, ChangeCommentPinStatusResponse. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of PinCommentResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of PinCommentResponse
     * @throws IOException if the JSON string is invalid with respect to PinCommentResponse
     */
    public static PinCommentResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, PinCommentResponse.class);
    }

    /**
     * Convert an instance of PinCommentResponse to an JSON string
     *
     * @return JSON string
     */
