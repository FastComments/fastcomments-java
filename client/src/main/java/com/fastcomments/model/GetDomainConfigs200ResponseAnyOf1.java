...
public class GetDomainConfigs200ResponseAnyOf1 {
   ...
   * @return the GetDomainConfigs200ResponseAnyOf1 instance itself
   */
  public GetDomainConfigs200ResponseAnyOf1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reason, getDomainConfigs200ResponseAnyOf1.reason) &&
        ...
        Objects.equals(this.additionalProperties, getDomainConfigs200ResponseAnyOf1.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDomainConfigs200ResponseAnyOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetDomainConfigs200ResponseAnyOf1 is not found in the empty JSON string", GetDomainConfigs200ResponseAnyOf1.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetDomainConfigs200ResponseAnyOf1>() {
           ...
           public GetDomainConfigs200ResponseAnyOf1 read(JsonReader in) throws IOException {
             ...
             GetDomainConfigs200ResponseAnyOf1 instance = thisAdapter.fromJsonTree(jsonObj);
