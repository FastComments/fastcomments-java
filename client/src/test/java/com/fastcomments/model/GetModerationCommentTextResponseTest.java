...
/**
 * Model tests for GetModerationCommentTextResponse
 */
public class GetModerationCommentTextResponseTest {
    private final GetModerationCommentTextResponse model = new GetModerationCommentTextResponse();
