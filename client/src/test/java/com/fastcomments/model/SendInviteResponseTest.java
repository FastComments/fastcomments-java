...
/**
 * Model tests for SendInviteResponse
 */
public class SendInviteResponseTest {
    private final SendInviteResponse model = new SendInviteResponse();
