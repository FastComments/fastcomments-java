...
/**
 * Model tests for UpdateUserBadgeResponse
 */
public class UpdateUserBadgeResponseTest {
    private final UpdateUserBadgeResponse model = new UpdateUserBadgeResponse();
